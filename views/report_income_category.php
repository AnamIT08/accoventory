                                                ...
                                                <table id="table-pagination" class="table table-striped table-hover green">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> <?php if($detail->type != 'invoice') { $category = $this->data_model->get_specific_column("name", array("id" => $detail->category), "settings_income_expense_category"); echo $category[0]->name; } else { echo "Sales"; } ?> </td>
