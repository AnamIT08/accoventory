                            ...
                            <div class="profile-sidebar">
                                ...
                                <div class="portlet light profile-sidebar-portlet bordered">
                                    <div class="ibox-title">
                                        <h5 id="titleBanner" style="font-weight:bold;">Add Bank</h5>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <div class="form-group form-md-line-input form-md-floating-label" id="username_here_status">
                                                    ...
                                                    <span id="email_msg" class="help-block">Enter bank name here...</span>
                                                </div>
                                            </div>
                                            <div class="col-xs-12" id="password_here">
                                                <div class="form-group form-md-line-input form-md-floating-label" id="password_here_status">
                                                    ...
                                                    <label for="password">Bank Name Short</label>
                                                    <span id="password_msg" class="help-block">Type bank name short here...</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
