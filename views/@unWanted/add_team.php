...
<html lang="en">
    ...
    <head>
        ...
        <style type="text/css">
            ...
            .fa-heart-o { color: #22313F !important; }
            .fa-heart { color: #36D7B7; }
                        	...
                        	<div class="profile-content">
	                            ...
	                            <div class="portlet light bordered">
	                                <div class="portlet-title">
                                        ...
                                        <a href="<?php echo base_url(); ?>team/" class="btn green-haze btn-sm" style="float: right;"><i class="fa fa-list"></i> Team List </a>
	                                </div>
		                                        ...
		                                        <div class="row" style="margin-top: 20px;">
			                                        <div class="col-md-12">
				                                        <form role="form" action="#">
				                                            ...
				                                            <div class="col-md-4">
				                                                <div class="form-group form-md-line-input form-md-floating-label">
				                                                    <div class="input-icon">
				                                                        ...
				                                                        <span class="help-block">Email here...</span>
				                                                        <i class="fa fa-building"></i>
				                                                    </div>
				                                                </div>
				                                            </div>
				                                            <div class="col-md-4">
				                                                <div class="form-group form-md-line-input form-md-floating-label">
				                                                    <div class="input-icon">
				                                                        ...
				                                                        <span class="help-block">Phone here...</span>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="col-md-12">
                                                                    <label for="col-sm-12" style="margin-bottom: 20px;"><i class="fa fa-mobile"></i> User Permissions</label>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="md-checkbox">
                                                                        <input id="checkbox1" class="md-check" checked="checked" type="checkbox">
                                                                        <label for="checkbox1">
                                                                            <span></span>
                                                                            <span class="check"></span>
                                                                            <span class="box"></span> Manage Transaction </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="md-checkbox">
                                                                        <input id="checkbox2" class="md-check" checked="checked" type="checkbox">
                                                                        <label for="checkbox2">
                                                                            <span></span>
                                                                            <span class="check"></span>
                                                                            <span class="box"></span> Manage Invoices  </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="md-checkbox">
                                                                        <input id="checkbox3" class="md-check" checked="checked" type="checkbox">
                                                                        <label for="checkbox3">
                                                                            <span></span>
                                                                            <span class="check"></span>
                                                                            <span class="box"></span> Manage Products  </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="md-checkbox">
                                                                        <input id="checkbox4" class="md-check" checked="checked" type="checkbox">
                                                                        <label for="checkbox4">
                                                                            <span></span>
                                                                            <span class="check"></span>
                                                                            <span class="box"></span> Manage Team  </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="md-checkbox">
                                                                        <input id="checkbox5" class="md-check" checked="checked" type="checkbox">
                                                                        <label for="checkbox5">
                                                                            <span></span>
                                                                            <span class="check"></span>
                                                                            <span class="box"></span> Manage Customers </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="md-checkbox">
                                                                        <input id="checkbox6" class="md-check" checked="checked" type="checkbox">
                                                                        <label for="checkbox6">
                                                                            <span></span>
                                                                            <span class="check"></span>
                                                                            <span class="box"></span> Manage Vendors </label>
                                                                    </div>
                                                                </div>      
                                                            </div>
