                            ...
                            <div class="profile-sidebar">
                                ...
                                <div class="portlet light profile-sidebar-portlet bordered">
                                    <div class="ibox-title">
                                        <h5 id="titleBanner" style="font-weight:bold;">Add User Role</h5>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 form-group-custom">
                                                <div class="form-group form-md-line-input form-md-floating-label" id="username_here_status">
                                                    ...
                                                    <span id="email_msg" class="help-block">Enter user role name here...</span>
                                                </div>
                                            </div>                                            
                                            <div class="form-group" style="width:90%; margin-left:5%">
                                                <label class="control-label">User Access Permission</label>
                                                <div class="panel panel-default panel-color-ascon" data-color="ascon">
                                                    <div class="panel-heading">
                                                        <div class="panel-actions-input">
                                                            <input class="form-control" id="jstree4_q" placeholder="Search" type="text">
                                                        </div>
                                                    </div><!-- /.panel-heading -->
...
<![endif]-->
       ...
       <script src="<?php echo base_url(); ?>assets/global/plugins/jstree/dist/jstree.checkbox.js" type="text/javascript"></script>
