                            ...
                            <div class="profile-sidebar">
                                ...
                                <div class="portlet light profile-sidebar-portlet bordered">
                                    <div class="ibox-title">
                                        <h5 id="titleBanner" style="font-weight:bold;">Add Email Template</h5>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 form-group-custom">
                                                <div class="form-group form-md-line-input form-md-floating-label" id="username_here_status">
                                                    ...
                                                    <span id="email_msg" class="help-block">Enter email subject here...</span>
                                                </div>
                                            </div>                                            
                                            ...
                                            <div id="form-group-message" class="form-group" style="width:90%; margin-left:5%;">
                                                <label for="order_id" class="smcol-sm-9 control-label">Email Body</label>
