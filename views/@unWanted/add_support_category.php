                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 form-group-custom">
                                                <div class="form-group form-md-line-input form-md-floating-label" id="username_here_status">
                                                    ...
                                                    <label for="email">Support Category Name</label>
                                                    <span id="email_msg" class="help-block">Enter support category name here...</span>
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12 text-right" style="margin-top:15px;">
                                                <button id="password_submit" class="btn blue" type="submit">Add Support Category</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
