        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                        	<div class="profile-content add_customer">
	                            <!-- BEGIN PORTLET -->
	                            <div class="portlet light bordered">
	                                <div class="portlet-title">
	                                    <div class="caption caption-md">
	                                        <i class="icon-bar-chart theme-font hide"></i>
	                                        <span class="caption-subject font-blue-madison bold uppercase">Add New Customer</span>
	                                        <span class="caption-helper hide">weekly stats...</span>
	                                    </div>
                                        <a href="<?php echo base_url(); ?>customer/" class="btn green-haze btn-sm" style="float: right;"><i class="fa fa-list"></i> Customer List </a>
	                                </div>
