									...
									<div class="portlet box light bordered">
										...
										<div id="portlet-body" class="portlet-body">
                                            <div style="text-align: center; margin: 10px 0px 25px 0px;">
                                                ...
                                                <span style="color: #000">Reporting period: <?php echo $dataId[0]->endDate." to ".$dataId[0]->startDate; ?></span>
                                            </div>
                                            <div class="table-scrollable">
                                                <table class="table table-striped table-hover green">
                                                    <thead>
                                                        <tr>
                                                            <th style="color: #FFFFFF; background: #A8642A; width: 20%;"> Revenue </th>
                                                            <th></th>
                                                        </tr>
                                                        <tr style="background-color: #5C9BD1; color: #FFFFFF">
                                                            <th> Accounts </th>
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                            $startDate = $dataId[0]->startDate." 00:00:00";
                                                            $endDate = $dataId[0]->endDate." 23:59:59";
                                                            $incomeTotal = 0;
                                                            ...
                                                            foreach ($incomeCategory as $income) {
                                                                if($income->name == "Sales") {
                                                                    ...
                                                                    $incomeTotal += $calculationSales = $incomeSales[0]->adjustAmount-$expenseSales[0]->adjustAmount+$incomeTransaction[0]->amount-$expenseTransaction[0]->amount;
                                                        ?>
                                                        <tr>
                                                            <td><?php echo ucfirst($income->name); ?></td>
                                                            <td style="text-align: right">
                                                                <?php 
                                                                    $currencySysmbol = explode("-", $basicSettings[0]->currencySymbol);
                                                                    echo $currencySysmbol[1];
                                                                ?>
                                                                <?php echo number_format($calculationSales, 2); ?>
                                                            </td>
                                                        </tr>
                                                        <?php } else { 
                                                                    ...
                                                                    $incomeTotal += $calculationSales = $incomeSales[0]->amount-$expenseSales[0]->amount;
                                                        ?>                                                        
                                                        <tr>
                                                            <td><?php echo ucfirst($income->name); ?></td>
                                                            <td style="text-align: right">
                                                        ...
                                                        <tr style="background-color: #e8e8e8">
                                                            ...
                                                            <th style="text-align: right">
                                                                <?php 
                                                                    ...
                                                                    echo $currencySysmbol[1];
                                                                ?>
                                                                <?php echo number_format($incomeTotal, 2); ?>
                                                            </th>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <div class="table-scrollable">
                                                <table class="table table-striped table-hover green">
                                                    <thead>
                                                        <tr>
                                                            <th style="color: #FFFFFF; background: #A8642A; width: 20% !important;"> COGS </th>
                                                            <th></th>
                                                        </tr>
                                                        <tr style="background-color: #5C9BD1; color: #FFFFFF">
                                                            <th></th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <td style="width: 20%;">Cost of Goods Sold(COGS)</td>
                                                            <td style="text-align: right">
                                                                <?php 
                                                                    $currencySysmbol = explode("-", $basicSettings[0]->currencySymbol);
                                                                    echo $currencySysmbol[1];
                                                ...
                                                <table class="table table-striped table-hover green">
                                                    <tbody>
                                                        <tr style="background: #555555;">
                                                            <th style="color: #FFFFFF; width: 20% !important;"> Gross Profit </th>
                                                            <th style="color: #FFFFFF; text-align: right">
                                                                <?php 
                                                                    $currencySysmbol = explode("-", $basicSettings[0]->currencySymbol);
                                                                    echo $currencySysmbol[1];
                                                                ?>
                                                                <?php $grossProfit = $incomeTotal-$totalCost; echo number_format($incomeTotal-$totalCost, 2) ?>
                                                            </th>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <div class="table-scrollable">
                                                <table class="table table-striped table-hover green">
                                                    <thead>
                                                        <tr>
                                                            <th style="color: #FFFFFF; background: #A8642A; width: 20%;"> Operating Expense </th>
                                                            <th></th>
                                                        </tr>
                                                        <tr style="background-color: #5C9BD1; color: #FFFFFF">
                                                            <th> Accounts </th>
                                            ...
                                            <div class="table-scrollable">
                                                <table class="table table-striped table-hover green">
                                                    <tbody>
                                                        <tr style="background: #36C6D3;">
                                                            <th style="color: #FFFFFF; width: 20% !important;"> Net Profit </th>
                                                            <th style="color: #FFFFFF; text-align: right">
                                                                <?php 
                                                                    $currencySysmbol = explode("-", $basicSettings[0]->currencySymbol);
                                                                    echo $currencySysmbol[1];
                                                                ?>
                                                                <?php echo number_format($grossProfit-$expenseTotal, 2) ?>
                                                            </th>
                                                        </tr>
                                                    </tbody>
                                                </table>
