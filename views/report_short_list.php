                                                ...
                                                <table id="table-pagination" class="table table-striped table-hover green">
                                                    ...
                                                    <tbody>
                                                        <?php $i = 1; foreach ($details as $detail) {
                                                            if($detail->balanceQuantity-$detail->sellingQuantity < $detail->alertQuantity) {
                                                        ?>
                                                        <tr>
                                                            <td> <?php echo $i++; ?> </td>
                                                            <td> <?php echo $detail->code ?> </td>
                                                            <td> <?php echo $detail->name ?> </td>
                                                            <td> <?php echo $detail->alertQuantity." ".$detail->unit; ?> </td>
                                                            ...
                                                            <td> <?php echo $detail->balanceQuantity-$detail->sellingQuantity." ".$detail->unit; ?> </td>
                                                        </tr>
                                                        <?php } } ?>
                                                    </tbody>
                                                </table>
