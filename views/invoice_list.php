...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Invoice | Accoventory .::.SaaS.::. Accounting & Inventory Software - SaaS</title>
        ...
        <style type="text/css">
            ...
            #select2-sample_10_length-e7-container, .select2-selection__rendered {
                display: none;
            }
            tr td:first-child {
                cursor: move;
            ...
            .deleteCustom { position: absolute !important; top: 5px !important; right: 45px !important; }.loadMore { margin-top: 10px !important; }
            ...
            .checkWarning { color: #C29D0C !important; display: none; }
        </style>
    </head>
    <!-- END HEAD -->
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md  pace-done">
                                    ...
                                    <div class="portlet box light bordered col-md-4" style="border: 3px solid #e7ecf1 !important;">
                                        <div class="portlet-body" style="min-height: 233px; color: #B6BEBE; font-size: 16px;">
                                            <div class="col-md-12 uppercase" style="margin-left: 5%; margin-top: 13% !important;"> 
                                                Total amount of all invoices <br/>
                                                <span style="font-size: 30px; color: #597B8C; font-weight: 550;">৳ <span id="totalCalculate"><?php echo number_format($purchaseTotal[0]->calculateTotalLocal, 2); ?></span></span>
                                                <span style="font-size: 22px; font-weight: 400;">BDT</span>
                                            </div>
                                            <div class="col-md-12 uppercase" style="margin-left: 5%;">
                                                Total dues of all invoices <br/>
                                                <span style="font-size: 30px; color: #597B8C; font-weight: 550;">৳ <span id="paidCalculate"><?php echo number_format(($purchaseTotal[0]->calculateTotalLocal - $purchasePaid), 2); ?></span></span>
                                                <span style="font-size: 22px; font-weight: 400;">BDT</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption caption-md">
                                            ...
                                            <span class="caption-subject font-blue-madison bold" style="color: #26C281 !important;">Add New Invoice</span>
                                            <span class="caption-helper hide">weekly stats...</span>
                                        </div>
                                        <div style="float: right;">
                                            <a class="btn green-haze btn-sm PurchaseListVisible"><i class="fa fa-list"></i> Invoice List </a>
                                            ...
                                            <div class="row"> 
                                                <div class="col-sm-offset-1 pull-right col-sm-5">
                                                    <div class="row">                                                        
                                                        <div id="purchaseLogo" class="col-sm-11 col-sm-offset-1 pull-left newDrop" style="display: <?php if($basicInvoiceEstimate[0]->defaultLogoSettings != "No" && $basicSettings[0]->bDefaultLogo == "") { echo "block"; } else { echo "none"; } ?>;">
                                                            <form action="<?php echo base_url(); ?>invoice/file_upload/" class="dropzone dropzone-file-area">                                                                
                                                ...
                                                <form id="addProduct" role="form" action="#">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="col-md-offset-1 col-md-11">
                                                                <div id="titleDiv" class="form-group form-md-line-input">
                                                                    <input id="title" class="form-control" placeholder="Bill (Optional)" name="title" type="text" value="<?php echo $basicInvoiceEstimate[0]->titleInvoice; ?>" style="font-size: 20px" />
                                                            ...
                                                            <!--
                                                            <div class="col-md-offset-1 col-md-11" style="margin-top: 15px;"> 
                                                                <div class="md-checkbox installmentCheckbox">
                                                                    <input id="checkbox4" class="md-check" type="checkbox" name="checkbox4" />
                                                                    <label for="checkbox4">
                                                                        <span></span>
                                                            ...
                                                            <div id="installmentPeriod" class="col-md-offset-1 col-md-11" style="margin-top: 20px; display: none"> 
                                                                <div class="form-group form-group-condensed">
                                                                    <div id="installmentPeriodDiv" class="form-group form-md-line-input">
                                                                        <input id="installmentTime" class="form-control customFormControl" placeholder="Number of scheduled *" name="installmentTime" value="<?php echo $basicSettings[0]->installmentSchedule; ?>" type="text">
                                                                        <div class="form-control-focus"> </div>
                                                                        <span id="installmentText" style="float: right; margin-top: -16px; font-weight: bold;">
                                                                            <?php 
                                                                            if($basicSettings[0]->installmentPeriod == "Monthly") { 
                                                                                echo "Months";
                                                                            } else if($basicSettings[0]->installmentPeriod == "Weekly") {
                                                                                echo "Weeks";
                                                                            } else { echo "Days";}
                                                                            ?>
                                                                        </span>
                                                            ...
                                                            <div id="radioPeriod" class="col-md-offset-1 col-md-11" style="margin-top: 15px; display: none"> 
                                                                <div class="md-radio-inline" style="margin-top: 15px;">
                                                                    <div class="md-radio">
                                                                        <input id="radio4" name="radio4" value="Monthly" <?php if($basicSettings[0]->installmentPeriod == "Monthly") echo 'checked=""'; ?> class="md-radiobtn radioChange" type="radio">
                                                                        <label for="radio4">
                                                                            <span></span>
                                                                            <span class="check"></span>
                                                                    ...
                                                                    <div class="md-radio">
                                                                        <input id="radio2" name="radio4" value="Weekly" <?php if($basicSettings[0]->installmentPeriod == "Weekly") echo 'checked=""'; ?> class="md-radiobtn radioChange" type="radio">
                                                                        <label for="radio2">
                                                                            <span></span>
                                                                            <span class="check"></span>
                                                                    ...
                                                                    <div class="md-radio">
                                                                        <input id="radio1" name="radio4" value="Daily" <?php if($basicSettings[0]->installmentPeriod == "Daily") echo 'checked=""'; ?> class="md-radiobtn radioChange" type="radio">
                                                                        <label for="radio1">
                                                                            <span></span>
                                                                            <span class="check"></span>
                                                        ...
                                                        <div class="divRightText pull-right col-sm-6">
                                                            <div class="col-sm-12">
                                                                <div id="invoiceNoDiv" class="form-group form-md-line-input">
                                                                    <div class="col-md-12">
                                                                        <input id="invoiceNo" class="form-control" name="invoiceNo" placeholder="Invoice #" type="text" value="" />
                                                                        <div class="form-control-focus"> </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <tbody class="ui-sortable knownSortable">
                                                                    <tr class="item item0" data-line-id="0" onmouseover="trRow('item0')">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <input class="form-control customInput checkQuantity" name="checkQuantity[]" placeholder="Quantity" value="" type="hidden" />
                                                                            <div style="color: gray" class="checkWarning">Selling quantity <b> <i class="fa fa-chevron-right"></i> </b> Stock quantity </div>
                                                    ...
                                                    <div class="col-md-offset-8 col-md-4">
                                                        <table class="table" id="PurchaseTotalTable">
                                                            <tbody>
                                                                ...
                                                                <tr class="total-row">
                                                                    <th class="text-left">Invoice Total: <span class="checkCurrency" style="float: right;"><?php $currency = explode("-", $basicSettings[0]->currencySymbol); echo $currency[1]; ?></span></th></th>
                                                    ...
                                                    <div class="col-md-12" style="margin-top: 25px;">
                                                        <div class="form-group form-md-line-input form-md-floating-label">
                                                            <div class="input-icon">
                                                                <textarea class="form-control noteProduct" type="text" name="noteProduct"><?php echo $anotherSettings[0]->noteInvoice; ?></textarea>
                                                                <label for="form_control_1">NOTES</label>                                                            
                                                                <span class="saveDefault" style="display: <?php if($anotherSettings[0]->noteInvoice != '') echo "none" ?>">
                                                                    <a class="tooltipCc">
                                                    ...
                                                    <div class="col-md-12 margiv-top-10"><br/>
                                                        ...
                                                        <input id="purchaseTotalOld" name="productTotalOld" value="" type="hidden" />
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        ...
                                        <div style="float: right;">
                                            ...
                                            <a class="btn green-haze btn-sm PurchaseAddVisible"><i class="fa fa-plus"></i> New Invoice </a>
                                        </div>
                                    </div>
                                    <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                    <div class="portlet box light bordered">
                                        <div class="portlet-title" style="padding-left:1.5%; padding-right:1.5%">
                                            <div class="caption">
                                                <i class="fa fa-th-list" style="color: #26C281;"></i><span class="caption-subject font-blue-madison bold" style="color: #26C281 !important;">Active Invoice List</span>
                                            </div>
                                            <div class="actions">
                                                <div class="btn-group btn-group-solid">
                                                    ...
                                                    <a class="dt-button buttons-print btn dark btn-outline" onclick="printData('sample_10', 'Invoice List Active')"><i class="fa fa-print"></i><span>Print</span></a>
                                                    <a class="dt-button btn yellow btn-outline" onclick="tableToExcel('sample_10', 'W3C Example Table')"><i class="fa fa-file-excel-o"></i><span>Excel</span></a>
                                                    <a class="btn default" href="#" data-toggle="dropdown">
                                                        <i class="fa fa-sliders"></i>More <i class="fa fa-angle-down"></i>
                                                    </a>
                                                    <div id="sample_10_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
                                                        ...
                                                        <label><input type="checkbox" checked data-column="3">Stock</label>
                                                        <label><input type="checkbox" checked data-column="4">Total</label>
                                                        <label><input type="checkbox" checked data-column="5">Due</label>
                                                        <label><input type="checkbox" data-column="6">Date</label>
                                                        <label><input type="checkbox" data-column="7">Customer</label>
                                                        <!-- <label><input type="checkbox" data-column="8">Installment</label> -->
                                                        <label><input type="checkbox" data-column="9">Invoice ID</label>
                                        ...
                                        <div id="portlet-body" class="portlet-body">
                                            <table class="table table-striped table-bordered table-hover dt-responsive" id="sample_10">
                                                <thead>
                                                    <tr>
                                                        <th class="no-sort">
                                                            Manage
                                                ...
                                                <tbody class="uiSortableList">
                                                    <?php foreach ($activePurchase as $activePurchaseResult) { 
                                                        $allComments = $this->data_model->get_all_info('*', array('docType' => 'invoice', 'docId' => $activePurchaseResult->id), 'list_all_comment');
                                                    ?>
                                                    <tr id="receipt<?php echo $activePurchaseResult->id; ?>">
                                                            ...
                                                            <div class="btn-group" style="margin: -5px">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-custom btn-group-circle" role="menu" style="position: absolute;">
                                                                    <li id="view<?php echo $activePurchaseResult->id; ?>">
                                                                        <a target="_blank" href="<?php echo base_url(); ?>invoice/viewInvoice/<?php echo $activePurchaseResult->id; ?>" class="liveLink"><i class="fa fa-search" style="color: #26C281;"></i><span>View</span></a>
                                                                    </li>
                                                                    <li id="history<?php echo $activePurchaseResult->id; ?>">
                                                                        <a target="_blank" href="<?php echo base_url(); ?>invoice/viewInvoice/<?php echo $activePurchaseResult->id; ?>/history" class="liveLink"><i class="fa fa-history" style="color: gray;"></i><span>History</span></a>
                                                                    </li>
                                                                    ...
                                                                    <li id="print<?php echo $activePurchaseResult->id; ?>">
                                                                        <a target="_blank" href="<?php echo base_url(); ?>invoice/printInvoice/<?php echo $activePurchaseResult->id; ?>" class="liveLink"><i class="fa fa-print" style="color: #000000;"></i><span>Print</span></a>
                                                                    </li>
                                                        ...
                                                        <td>
                                                            <?php
                                                                ...
                                                                $dEnd  = new DateTime($activePurchaseResult->dueDate);
                                                                $dDiff = $dStart->diff($dEnd);
                                                                $diff = $dDiff->format("%R%a");
                                                                // print_r($dEnd);
                                                                // echo $diff;
                                                                $amountExpense = $this->data_model->columnSum('adjustAmount', array('docType' => 'invoice', 'documentId' => $activePurchaseResult->id, 'type' => 'Expense'), 'list_payment'); 
                                                                $amountIncome = $this->data_model->columnSum('adjustAmount', array('docType' => 'invoice', 'documentId' => $activePurchaseResult->id, 'type' => 'Income'), 'list_payment'); 
                                                                $purchasePaid = $amountIncome[0]->adjustAmount-$amountExpense[0]->adjustAmount;
                                                                $foreignPurchasePaid = number_format($purchasePaid/$activePurchaseResult->currencyRate, 2);   
                                                                if($diff > 0) {
                                                                    $textColor = '';
                                                                    if($activePurchaseResult->currencyType == "local") {
                                                                        if(number_format($purchasePaid, 2) <= number_format($activePurchaseResult->calculateTotalLocal, 2)) {
                                                                            if(number_format($purchasePaid, 2) == number_format($activePurchaseResult->calculateTotalLocal, 2)) {
                                                                                echo '<span class="label label-sm" style="background: green"> Paid </span>';
                                                                            } else if(number_format($purchasePaid, 2) > '0.00' && number_format($purchasePaid, 2) < number_format($activePurchaseResult->calculateTotalLocal, 2)) {
                                                                               echo '<span class="label label-sm label-danger"> Partial </span>';
                                                                            } else if($activePurchaseResult->cStatus == 2) {
                                                                                echo '<span class="label label-sm label-success"> Sent </span>';
                                                                            } else if($activePurchaseResult->cStatus == 3) {
                                                                        ...
                                                                        if(number_format($foreignPurchasePaid, 2) <= number_format($activePurchaseResult->calculateTotalLocal, 2)) {
                                                                            if(number_format($foreignPurchasePaid, 2) == number_format($activePurchaseResult->calculateTotalLocal, 2)) {
                                                                                echo '<span class="label label-sm" style="background: green"> Paid </span>';
                                                                            } else if(number_format($foreignPurchasePaid, 2) > '0.00' && number_format($foreignPurchasePaid, 2) < number_format($activePurchaseResult->calculateTotalLocal, 2)) {
                                                                               echo '<span class="label label-sm label-danger"> Partial </span>';
                                                                            } else if($activePurchaseResult->cStatus == 2) {
                                                                                echo '<span class="label label-sm label-success"> Sent </span>';
                                                                            } else if($activePurchaseResult->cStatus == 3) {
                                                                    ...
                                                                    if($activePurchaseResult->currencyType == "local") {
                                                                        if($diff == 0) {
                                                                        ...
                                                                        } else if($activePurchaseResult->paymentStatus == 2) {
                                                                            if(number_format($purchasePaid, 2) <= number_format($activePurchaseResult->calculateTotalLocal, 2)) {
                                                                                echo '<span class="label label-sm" style="background: green"> Paid </span>';
                                                                            } else {
                                                                                echo '<span class="label label-sm" style="background: red"> <b style="color: #000 !important">Overpaid</b> </span>';
                                                                            ...
                                                                            echo '<span class="label label-sm" style="background: red"> Overdue </span>';
                                                                        }
                                                                    } else {
                                                                        if($diff == 0) {
                                                                            if(number_format($foreignPurchasePaid, 2) == number_format($activePurchaseResult->calculateTotalLocal, 2)) {
                                                            ...
                                                            ?>
                                                            <span id="date<?php echo $activePurchaseResult->id; ?>" style="display:none;"><?php echo date("d-m-Y", strtotime($activePurchaseResult->date)); ?></span>
                                                            ...
                                                            <span id="totalPurchase<?php echo $activePurchaseResult->id; ?>" style="display:none;">
                                                                <?php
                                                                    if($activePurchaseResult->currencyType == "foreign")  {
                                                                        echo $activePurchaseResult->calculateTotal;
                                                                    } else {
                                                                        echo $activePurchaseResult->calculateTotalLocal;
                                                                    }
                                                                ?>
                                                            </span>
                                                            <?php 
                                                                $amountExpense = $this->data_model->columnSum('adjustAmount', array('docType' => 'purchase', 'documentId' => $activePurchaseResult->id, 'type' => 'Expense'), 'list_payment'); 
                                                                $amountIncome = $this->data_model->columnSum('adjustAmount', array('docType' => 'purchase', 'documentId' => $activePurchaseResult->id, 'type' => 'Income'), 'list_payment'); 
                                                                $purchasePaid = $amountExpense[0]->adjustAmount-$amountIncome[0]->adjustAmount;
                                                            ?>                                                      
                                                            <span id="duePurchase<?php echo $activePurchaseResult->id; ?>" style="display:none;">
                                                                <?php 
                                                                    if($activePurchaseResult->currencyType == "foreign")  {
                                                                        echo number_format(($activePurchaseResult->calculateTotalLocal-$purchasePaid)/$activePurchaseResult->currencyRate, 2);
                                                                    } else {
                                                                        echo $activePurchaseResult->calculateTotalLocal-$purchasePaid;
                                                                    }
                                                                ?>
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <?php 
                                                                ...
                                                                $incrementSts = 0;
                                                                $incrementCal = 0;
                                                                $allProductAdjust = $this->data_model->get_specific_column('*', array('documentId' => $activePurchaseResult->id), 'list_product_adjust');
                                                                foreach ($allProductAdjust as $adjustProduct) {
                                                                    ...
                                                                    if($overAdjust < 1) {
                                                                        if($adjustProduct->adjustProduct < 0) {
                                                                            $overAdjust++;                
                                                                        }
                                                                    }
                                                                }
                                                                $statusArray = array();
                                                                $statusIncrement = 0;
                                                                $min = $this->data_model->get_specific_column('adjustStatus', array('documentId' => $activePurchaseResult->id), 'list_product_adjust');
                                                                foreach ($min as $key) {
                                                                    $statusArray[$statusIncrement++] = $key->adjustStatus;
                                                                }
                                                                if($overAdjust < 1) {
                                                                    if(in_array(1, $statusArray) == -1) {
                                                                        echo '<span class="label label-sm" style="background: #3598DC"> Partly Adjust </span>';
                                                                    } else if(in_array(0, $statusArray) && in_array(2, $statusArray)) {
                                                                        echo '<span class="label label-sm" style="background: #3598DC"> Partly Adjust </span>';
                                                                    } else if(in_array(0, $statusArray)) {
                                                                        echo '<span class="label label-sm" style="background: #C49F47"> Not Adjust </span>';
                                                                    } else {
                                                                        echo '<span class="label label-sm" style="background: #36C6D3"> Adjust </span>';
                                                                    } 
                                                                } else { 
                                                                    echo '<span class="label label-sm" style="background: red"> <b style="color:#000">Stock Over Adjust</b> </span>';
                                                                }
                                                            ?>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <?php 
                                                                ...
                                                                if($activePurchaseResult->currencyType == 'local') {
                                                                    $currencySysmbol = explode("-", $basicSettings[0]->currencySymbol);
                                                                    echo $currencySysmbol[1]." ".number_format($activePurchaseResult->calculateTotal - $purchasePaid, 2);
                                                                } else {
                                                                    $currencySysmbol = explode("-", $basicSettings[0]->foreignCurrencySymbol);
                                                                    echo $currencySysmbol[1];
                                                                    echo    '<a class="tooltipC">
                                                                                <span> '.number_format($activePurchaseResult->calculateTotal - $purchasePaid/$activePurchaseResult->currencyRate, 2).' </span>
                                                                                <span class="sTooltip"><strong>'.$localSymbol." ".number_format($activePurchaseResult->calculateTotal*$activePurchaseResult->currencyRate - $purchasePaid, 2).'</strong></span>
                                                                            </a>';
                                                                }
                                                            ?> 
                                                        </td>
                                                        <td>
                                                            <?php echo date("d-m-Y", strtotime($activePurchaseResult->date)); ?>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td style="display: none;">
                                                            <?php if($activePurchaseResult->isInstallment == 0){ ?>                                                            
                                                                                ...
                                                                                <div id="sysfrm_ajaxrender">
                                                                                    <section class="activity-post mb-xlg">
                                                                                        <form id="commentForm<?php echo $activePurchaseResult->id; ?>">
                                                                                            ...
                                                                                            <input id="commentType<?php echo $activePurchaseResult->id; ?>" name="commentType<?php echo $activePurchaseResult->id; ?>" value="invoice" type="hidden">
                                                                                        ...
                                                                                        <div class="compose-box-footer">
                                                                                            ...
                                                                                            <ul class="compose-btn">
                                                                                                <li>
                                                                                                    <a class="save<?php echo $activePurchaseResult->id; ?> btn btn-success btn-xs" onClick="commentProcess('sample_10', <?php echo $activePurchaseResult->id; ?>)"><i class="fa fa-edit"></i> Add Note</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                        ...
                                                                                                        <div class="col-xs-10 content no-top-border myPermission">
                                                                                                            <div class="allAccess">
                                                                                                                ...
                                                                                                                <?php if($this->session->userdata('id') == $comment->createdBy) { ?>
                                                                                                                    <i onclick="editComment('vendor', <?php echo $activePurchaseResult->id; ?>, <?php echo $comment->id; ?>)" class="fa fa-edit permission iconEdit iconMark"></i>
                            ...
                            <div class="profile-content">
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet box light bordered">
                                        <div class="portlet-title" style="padding-left:1.5%; padding-right:1.5%">
                                            <div class="caption">
                                                <i class="fa fa-th-list" style="color: #26C281;"></i><span class="caption-subject font-blue-madison bold" style="color: #26C281 !important;">Archive Invoice List</span>
                                            </div>
                                            <div class="actions">
                                                <div class="btn-group btn-group-solid">
                                                    <!-- <a id="cPage" class="dt-button buttons-print btn gray btn-outline"><i class="fa fa-plus-square-o" style="color: #555555;"></i><span>Current Page</span></a>
                                                    <a id="tTable" class="dt-button buttons-print btn gray btn-outline"><i class="fa fa-plus-square" style="color: #555555;"></i><span>Total Table</span></a> -->
                                                    <a class="dt-button buttons-print btn dark btn-outline" onclick="printData('sample_1010', 'Invoice List Inactive')"><i class="fa fa-print"></i><span>Print</span></a>
                                                    <a class="dt-button btn yellow btn-outline" onclick="tableToExcel('sample_1010', 'W3C Example Table')"><i class="fa fa-file-excel-o"></i><span>Excel</span></a>
                                                    <a class="btn default" href="#" data-toggle="dropdown">
                                                        <i class="fa fa-sliders"></i>More <i class="fa fa-angle-down"></i>
                                                    </a>
                                                    <div id="sample_1010_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
                                                        <label><input type="checkbox" checked data-column="0">Show Notes</label>
                                                        <label><input type="checkbox" checked data-column="1">Manage</label>
                                                        <label><input type="checkbox" checked data-column="2">Status</label>
                                                        <label><input type="checkbox" checked data-column="3">Stock</label>
                                        ...
                                        <div id="portlet-body" class="portlet-body">
                                            <table class="table table-striped table-bordered table-hover dt-responsive" id="sample_1010">
                                                <thead>
                                                    <tr>
                                                        <th>
                                                            Manage
                                                ...
                                                <tbody class="uiSortableList">
                                                    <?php foreach ($inActivePurchase as $inActivePurchaseResult) { 
                                                        $allComments = $this->data_model->get_all_info('*', array('docType' => 'invoice', 'docId' => $inActivePurchaseResult->id), 'list_all_comment');
                                                    ?>
                                                    <tr id="receipt<?php echo $inActivePurchaseResult->id; ?>">
                                                            ...
                                                            <div class="btn-group" style="margin: -5px">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-custom btn-group-circle" role="menu" style="position: absolute;">
                                                                    <li id="view<?php echo $inActivePurchaseResult->id; ?>">
                                                                        <a target="_blank" href="<?php echo base_url(); ?>invoice/viewInvoice/<?php echo $inActivePurchaseResult->id; ?>" class="liveLink"><i class="fa fa-search" style="color: #26C281;"></i><span>View</span></a>
                                                                    </li>
                                                                    <li id="history<?php echo $inActivePurchaseResult->id; ?>">
                                                                        <a target="_blank" href="<?php echo base_url(); ?>invoice/viewInvoice/<?php echo $inActivePurchaseResult->id; ?>/history" class="liveLink"><i class="fa fa-history" style="color: gray;"></i><span>History</span></a>
                                                                    </li>
                                                                    <li id="print<?php echo $inActivePurchaseResult->id; ?>">
                                                                        <a target="_blank" href="<?php echo base_url(); ?>invoice/printInvoice/<?php echo $inActivePurchaseResult->id; ?>" class="liveLink"><i class="fa fa-print" style="color: #000000;"></i><span>Print</span></a>
                                                                    </li>
                                                        ...
                                                        <td>
                                                            <?php
                                                                $dStart = new DateTime(date("Y-m-d"));
                                                                $dEnd  = new DateTime($inActivePurchaseResult->dueDate);
                                                                $dDiff = $dStart->diff($dEnd);
                                                                $diff = $dDiff->format("%R%a");
                                                                $amountExpense = $this->data_model->columnSum('adjustAmount', array('docType' => 'invoice', 'documentId' => $inActivePurchaseResult->id, 'type' => 'Expense'), 'list_payment'); 
                                                                $amountIncome = $this->data_model->columnSum('adjustAmount', array('docType' => 'invoice', 'documentId' => $inActivePurchaseResult->id, 'type' => 'Income'), 'list_payment'); 
                                                                $purchasePaid = $amountIncome[0]->adjustAmount-$amountExpense[0]->adjustAmount;
                                                                $foreignPurchasePaid = number_format($purchasePaid/$inActivePurchaseResult->currencyRate, 2);
                                                                if($diff > 0) {
                                                                    $textColor = '';
                                                                    if($inActivePurchaseResult->currencyType == "local") {
                                                                        if(number_format($purchasePaid, 2) <= $inActivePurchaseResult->calculateTotalLocal) {
                                                                            if(number_format($purchasePaid, 2) == $inActivePurchaseResult->calculateTotalLocal) {
                                                                                echo '<span class="label label-sm" style="background: green"> Paid </span>';
                                                                            } else if(number_format($purchasePaid, 2) > '0.00' && number_format($purchasePaid, 2) < $inActivePurchaseResult->calculateTotalLocal) {
                                                                               echo '<span class="label label-sm label-danger"> Partial </span>';
                                                                            } else if($inActivePurchaseResult->cStatus == 2) {
                                                                                echo '<span class="label label-sm label-success"> Sent </span>';
                                                                            } else if($inActivePurchaseResult->cStatus == 3) {
                                                                                echo '<span class="label label-sm label-warning"> Viewed </span>';
                                                                            } else {
                                                                                echo '<span class="label label-sm" style="background: #3598DC"> Draft </span>';
                                                                            }
                                                                        ...
                                                                        if(number_format($foreignPurchasePaid, 2) <= $inActivePurchaseResult->calculateTotalLocal) {
                                                                            if(number_format($foreignPurchasePaid, 2) == $inActivePurchaseResult->calculateTotalLocal) {
                                                                                echo '<span class="label label-sm" style="background: green"> Paid </span>';
                                                                            } else if(number_format($foreignPurchasePaid, 2) > '0.00' && number_format($foreignPurchasePaid, 2) < $inActivePurchaseResult->calculateTotalLocal) {
                                                                               echo '<span class="label label-sm label-danger"> Partial </span>';
                                                                            } else if($inActivePurchaseResult->cStatus == 2) {
                                                                                echo '<span class="label label-sm label-success"> Sent </span>';
                                                                            } else if($inActivePurchaseResult->cStatus == 3) {
                                                                    ...
                                                                    if($inActivePurchaseResult->currencyType == "local") {
                                                                        ...
                                                                        } else if($inActivePurchaseResult->paymentStatus == 2) {
                                                                            if(number_format($purchasePaid, 2) <= $inActivePurchaseResult->calculateTotalLocal) {
                                                                                echo '<span class="label label-sm" style="background: green"> Paid </span>';
                                                                            } else {
                                                                                echo '<span class="label label-sm" style="background: red"> <b style="color: #000 !important">Overpaid</b> </span>';
                                                            ...
                                                            ?>
                                                            <span id="date<?php echo $inActivePurchaseResult->id; ?>" style="display:none;"><?php echo date("d-m-Y", strtotime($inActivePurchaseResult->date)); ?></span>
                                                            ...
                                                            <span id="totalPurchase<?php echo $inActivePurchaseResult->id; ?>" style="display:none;">
                                                                <?php
                                                                    if($inActivePurchaseResult->currencyType == "foreign")  {
                                                                        echo $inActivePurchaseResult->calculateTotal;
                                                                    } else {
                                                                        echo $inActivePurchaseResult->calculateTotalLocal;
                                                                    }
                                                                ?>
                                                            </span>
                                                            <?php 
                                                                $amountExpense = $this->data_model->columnSum('adjustAmount', array('docType' => 'purchase', 'documentId' => $inActivePurchaseResult->id, 'type' => 'Expense'), 'list_payment'); 
                                                                $amountIncome = $this->data_model->columnSum('adjustAmount', array('docType' => 'purchase', 'documentId' => $inActivePurchaseResult->id, 'type' => 'Income'), 'list_payment'); 
                                                                $purchasePaid = $amountExpense[0]->adjustAmount-$amountIncome[0]->adjustAmount;
                                                            ?>                                                      
                                                            <span id="duePurchase<?php echo $inActivePurchaseResult->id; ?>" style="display:none;">
                                                                <?php 
                                                                    if($inActivePurchaseResult->currencyType == "foreign")  {
                                                                        echo number_format(($inActivePurchaseResult->calculateTotalLocal-$purchasePaid)/$inActivePurchaseResult->currencyRate, 2);
                                                                    } else {
                                                                        echo $inActivePurchaseResult->calculateTotalLocal-$purchasePaid;
                                                                    }
                                                                ?>
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <?php 
                                                                ...
                                                                $incrementSts = 0;
                                                                $incrementCal = 0;
                                                                $allProductAdjust = $this->data_model->get_specific_column('*', array('documentId' => $inActivePurchaseResult->id), 'list_product_adjust');
                                                                foreach ($allProductAdjust as $adjustProduct) {
                                                                    $adjustQty[$incrementQty++] = $adjustProduct->totalProduct;
                                                                    $adjustId[$incrementQty-1] = $adjustProduct->productId;
                                                                    $infoProduct = $this->data_model->get_specific_column("*", array('id' => $adjustProduct->productId), 'list_product_enrollment');
                                                                ...
                                                                $statusArray = array();
                                                                $statusIncrement = 0;
                                                                $min = $this->data_model->get_specific_column('adjustStatus', array('documentId' => $inActivePurchaseResult->id), 'list_product_adjust');
                                                                foreach ($min as $key) {
                                                                    $statusArray[$statusIncrement++] = $key->adjustStatus;
                                                                }
                                                                if($overAdjust < 1) {
                                                        ...
                                                        <td>
                                                            <?php 
                                                                ...
                                                                if($inActivePurchaseResult->currencyType == 'local') {
                                                                    $currencySysmbol = explode("-", $basicSettings[0]->currencySymbol);
                                                                    echo $currencySysmbol[1]." ".number_format($inActivePurchaseResult->calculateTotal - $purchasePaid, 2);
                                                                } else {
                                                                    $currencySysmbol = explode("-", $basicSettings[0]->foreignCurrencySymbol);
                                                                    echo $currencySysmbol[1];
                                                                    echo    '<a class="tooltipC">
                                                                                <span> '.number_format($inActivePurchaseResult->calculateTotal - $purchasePaid/$inActivePurchaseResult->currencyRate, 2).' </span>
                                                                                <span class="sTooltip"><strong>'.$localSymbol." ".number_format($inActivePurchaseResult->calculateTotal*$inActivePurchaseResult->currencyRate - $purchasePaid, 2).'</strong></span>
                                                                            </a>';
                                                                }
                                                            ?> 
                                                        </td>
                                                        ...
                                                        <td style="display: none;">
                                                            <?php if($inActivePurchaseResult->isInstallment == 0){ ?>                                                            
                                                            <span class="label label-sm label-warning"> No </span>
                                                            <?php } else { ?>
                                                            <span class="label label-sm label-success"> Yes </span>
                                                            <?php } ?>
                                                                                ...
                                                                                <div id="sysfrm_ajaxrender">
                                                                                    <section class="activity-post mb-xlg">
                                                                                        <form id="commentForm<?php echo $inActivePurchaseResult->id; ?>">
                                                                                            ...
                                                                                            <input id="commentType<?php echo $inActivePurchaseResult->id; ?>" name="commentType<?php echo $inActivePurchaseResult->id; ?>" value="invoice" type="hidden">
                                                                                        ...
                                                                                        <div class="compose-box-footer">
                                                                                            ...
                                                                                            <ul class="compose-btn">
                                                                                                <li>
                                                                                                    <a class="save<?php echo $inActivePurchaseResult->id; ?> btn btn-success btn-xs" onClick="commentProcess('sample_66', <?php echo $inActivePurchaseResult->id; ?>)"><i class="fa fa-edit"></i> Add Note</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    ...
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div class="col-xs-10 content no-top-border myPermission">
                                                                                                            <div class="allAccess">
                                                                                                                <i class="fa<?php echo $comment->id; ?> fa <?php echo $comment->commentIcon; ?> iconMark"></i>
                                                                                                                <?php if($this->session->userdata('id') == $comment->createdBy) { ?>
                                                                                                                    <i onclick="editComment('vendor', <?php echo $inActivePurchaseResult->id; ?>, <?php echo $comment->id; ?>)" class="fa fa-edit permission iconEdit iconMark"></i>
                                                                                                                    <i onclick="deleteComment('sample_10', <?php echo $inActivePurchaseResult->id; ?>, <?php echo $comment->id; ?>)" class="fa fa-trash permission iconDelete iconMark"></i>
                                                                                                                <?php } ?>
                                                                                                            </div>
                                                                                                            <p class="m-b-xs"><strong><?php echo $team[0]->name; ?></strong></p>
                                                                                                            <p class="text<?php echo $comment->id; ?>"><?php echo $comment->comments ?></p>
        ...
        <script type="text/javascript"> 
            ...
            var purchaseTerms = '<?php echo $basicInvoiceEstimate[0]->paymentTermInvoice; ?>';
            ...
            <?php $dataPurhaseStatus = array(array('name' => $paid." Paid", 'color' => "#36C6D3", 'y' => $paid), array('name' => $partial." Partial", 'color' => "#337AB7", 'y' => $partial), array('name' => $overDue." Unpaid", 'color' => "#ED6B75", 'y' => $overDue)); ?>
            ...
            var countInvoices = <?php echo $countInvoice; ?>;
            var liveSystemCode = '';
        ...
        <script>
            ...
            function purchaseListId() {
                ...
                $("#purchaseSystemCode").val("bcin"+(currentpurchase));
            }
            ...
            $('#checkbox4').click(function() {
                if ($(this).is(':checked')) {
                    $('.installmentCheckbox').removeClass('has-warning');
            ...
            jQuery(document).ready(function() {
                ...
                $(".productTable").on('change', '.purchaseOption', function (e) {  
                    ...
                    if(editCalled != 1) {
                        ...
                        $.ajax({
                            url: base_link+'invoice/getProductInfo/invoice',
                            type: 'POST',
                            data: 'id='+$(this).val(),
                            async: false,
                            beforeSend: function() {
                            ...
                            success: function (response) {
                                ...
                                $('.'+trRowId).closest('tr').find('.checkQuantity').val(r.quantity);
                                if(r.unit != '') {
            ...
            function editData(id) {
                ...
                customerSelect[0].selectize.setValue($('#receipt'+id).closest('tr').find('td:eq(2) #member'+id).text().trim(), true);
                $('.oldVendorInfo').slideDown('fast');
                $.post(base_link+"vendor/getVendor",{
                  id: $('#receipt'+id).closest('tr').find('td:eq(2) #member'+id).text().trim()
                },
                function(data, status){
                    r = $.parseJSON(data);
                    vendorName = r.response;
                ...
                $('#invoiceNo').val($('#receipt'+id).closest('tr').find('td:eq(2) #invoiceNo'+id).text().trim());
                $('#poOptional').val($('#receipt'+id).closest('tr').find('td:eq(2) #poOptional'+id).text().trim());
                $('#invoiceDate').val($('#receipt'+id).closest('tr').find('td:eq(2) #invoiceDate'+id).text().trim());
                $('#pickDate').val($('#receipt'+id).closest('tr').find('td:eq(2) #pickDate'+id).text().trim());
                var disAmnt = $('#receipt'+id).closest('tr').find('td:eq(2) #discountRate'+id).text().trim();
                var disTyp = $('#receipt'+id).closest('tr').find('td:eq(2) #discountType'+id).text().trim();
                var curTyp = $('#receipt'+id).closest('tr').find('td:eq(2) #currencyType'+id).text().trim();
                if(disAmnt != '0.00') {
                    $('.radioCheck').slideDown("slow");
                    $('#discountCheck').val($('#receipt'+id).closest('tr').find('td:eq(2) #discountRate'+id).text().trim());
                    if(disTyp == 'percent') {
                ...
                if(curTyp != 'local') {
                    ...
                    $('#currencyRate').val($('#receipt'+id).closest('tr').find('td:eq(2) #currencyRate'+id).text().trim());
                    $('.checkCurrency').text(currencyForeign[1]);
                } else {
                    $('#radio6').prop('checked', true);
                    $('.checkCurrency').text(currencyLocal[1]);
                }
                $('.noteProduct').val($('#receipt'+id).closest('tr').find('td:eq(2) #note'+id).text().trim());
                $('.remarkProduct').addClass('edited');
                $('.remarkProduct').val($('#receipt'+id).closest('tr').find('td:eq(2) #remarks'+id).text().trim());
                $('#purchaseEditId').val(id);
                $('#purchasefiles').val($('#receipt'+id).closest('tr').find('td:eq(2) #attachFile'+id).text().trim());
                var fileAll = $('#receipt'+id).closest('tr').find('td:eq(2) #attachFile'+id).text().trim().split("::");
                if(fileAll != '') {
                ...
                $('#purchaseDueAmount').val($('#receipt'+id).closest('tr').find('td:eq(2) #duePurchase'+id).text().trim());
                $('#purchaseTotalOld').val($('#receipt'+id).closest('tr').find('td:eq(2) #totalPurchase'+id).text().trim());
                var start = moment($('#invoiceDate').val(), "DD-MM-YYYY");
                var end   = moment($('#pickDate').val(), "DD-MM-YYYY");
                var days   = (end - start)/1000/60/60/24;
                if(!start || !end) {
            ...
            function deleteData(id) {
                ...
                function(isConfirm){
                    ...
                    if (isConfirm) {
                        ...
                        var rowIndex = $('#sample_1010').dataTable().fnAddData( 
                            [ 
                                ...
                                table.row('#receipt'+id).data()[10],
                                table.row('#receipt'+id).data()[11],
                                remarks
                            ]
                        );
                        var row = $('#sample_1010').dataTable().fnGetNodes(rowIndex);
                        $(row).attr('id', 'receipt'+id);
                        $('#sample_1010 tr td:last-child').css('display', 'none');
                                      
                        $.ajax({
                            type: 'post',
                            url: base_link + "invoice/productStatus",
                            data: 'id='+ id + '&status=' + 0,
                            success: function(response) {
                                r = $.parseJSON(response);
                                if(r.response == "success") {
                                    ...
                                    setTimeout(function() {
                                        setTimeout(function() {
                                            $('.countInvoices').text(--countInvoices);
                                            var currencyResult = r.dataCurrency.split("::");
                                            var dataCurrency = [{"name": parseInt(currencyResult[0])+" Local", "color": "#F1C40F", "y": parseInt(currencyResult[0])}, {"name": parseInt(currencyResult[1])+" Foreign", "color": "#36C6D3", "y": parseInt(currencyResult[1])}];
                                            var highchart_5 = $('#highchart_5').highcharts();
                                            highchart_5.series[0].setData(dataCurrency);
                                            var statusResult = r.dataStatus.split("::");
                                            var statusData = [{"name": parseInt(statusResult[2])+" Unpaid", "color": "#ED6B75", "y": parseInt(statusResult[2])}, {"name": parseInt(statusResult[1])+" Partial", "color": "#337AB7", "y": parseInt(statusResult[1])}, {"name": parseInt(statusResult[0])+" Paid", "color": "#36C6D3", "y": parseInt(statusResult[0])}];
                                            var highchart_6 = $('#highchart_6').highcharts();
                                            highchart_6.series[0].setData(statusData);
                                            var amountCalculate = r.calculate.split("::");
                                            $('#totalCalculate').text(amountCalculate[0]);
                                            $('#paidCalculate').text(amountCalculate[1]);
                                            $("#receipt"+id).slideUp("normal", function() { $(this).remove(); });
                                            toastr.error(" You successfully archive invoice ", "Archive Invoice");
                                        }, 1500);
                                        swal({
                                            title: "Archive!",
                                            text: "This invoice has been archived.",
                                            timer: 3000,
                                            type : "success",
                                    ...
                                    $.ajax({
                                        ...
                                        data: 'systemId=bcra'+activityId+ '&userId='+userId+ '&workType=archive'+ '&title=invoice'+ '&type='+ acType + '&label='+ acLabel + '&fullLink=settings',
                                        type: "POST",
										dataType: 'json',
										contentType: 'json',
            ...
            function activeData(id) {
                ...
                function(isConfirm){
                    ...
                    if (isConfirm) {
                        ...
                        var remarks = $('#receipt'+id).closest('tr').find('td:eq(6)').html();                        
                        var rowIndex = $('#sample_10').dataTable().fnAddData( 
                            [ 
                                '<span class="row-details row-details-close"></span>',
                                $('#receipt'+id).closest('tr').find('td:eq(1)').html(),
                                table.row('#receipt'+id).data()[2],
                        ...
                        var row = $('#sample_10').dataTable().fnGetNodes(rowIndex);
                        $(row).attr('id', 'receipt'+id);
                        $('#sample_10 tr td:last-child').css('display', 'none');
                                ...
                                if(r.response == "success") {
                                    ...
                                    setTimeout(function() {
                                        setTimeout(function() {
                                            ...
                                            $('#totalCalculate').text(amountCalculate[0]);
                                            $('#paidCalculate').text(amountCalculate[1]);
                                            $("#sample_1010 #receipt"+id).slideUp("normal", function() { $(this).remove(); });
                                            toastr.success(" You successfully active invoice ", "Active Invoice");
                                        }, 1500);
                                        swal({
                                            title: "Activate!",
                                            text: "This invoice has been activate.",
                                            timer: 3000,
                                            type : "success",
                                            showConfirmButton: false
                                        });
                                    ...
                                    $.ajax({
                                        url: base_link+'recent_activity/add_activity/',
                                        data: 'systemId=bcra'+activityId+ '&userId='+userId+ '&workType=active'+ '&title=invoice'+ '&type='+ acType + '&label='+ acLabel + '&fullLink=settings',
                                        type: "POST",
										dataType: 'json',
										contentType: 'json',
                                        success: function(json) {
            ...
            $('#purchaseSave').live('click', function(e) {
                ...
                if($('input:checkbox[name=checkbox4]:checked').val() == "on") {
                    if($('#installmentTime').val() != '') {
                        $('#installmentPeriodDiv').removeClass('has-error');
                    ...
                    $('.installmentCheckbox').addClass('has-warning');
                }
                if (title != '') {
                ...
                var totalRate = 0;
                if(currencyCheck == "foreign") {
                    var purchaseCurrency = currencyForeign[1];
                    if($('#currencyRate').val() != '') {
                ...
                var typeStatus = '<span class="label label-sm" style="background: #3598DC"> Draft </span>';
                var typeStock = '<span class="label label-sm" style="background: #C49F47"> Not Adjust </span>';
                var installmentType = '';
                // if($('input[name="radio6"]:checked', '#addProduct').val() == 'local') {
                //     installmentType = '<span class="label label-sm label-warning"> Local </span>';
                // } else {
                //     installmentType = '<span class="label label-sm label-success"> Foreign </span>';
                // }
                ...
                var inStockError = false;
                $(".unitInput").each(function() {
                    var inStock = $(this).closest('tr').find('.checkQuantity').val();
                    if(($(this).val()) != '') {
                        if(parseInt($(this).val()) > parseInt(inStock)) {
                            $(this).closest('tr').find('.checkWarning').slideDown("slow");
                            $(this).closest('.unitInputDiv').removeClass('has-success');
                            $(this).closest('.unitInputDiv').removeClass('has-error');
                            $(this).closest('.unitInputDiv').addClass('has-warning');
                            inStockError = true;
                        } else {
                            $(this).closest('tr').find('.checkWarning').slideUp("slow");
                            unitInput[unitInputI++] = $(this).val();
                            $(this).closest('.unitInputDiv').addClass('has-success');
                            $(this).closest('.unitInputDiv').removeClass('has-error');
                            $(this).closest('.unitInputDiv').removeClass('has-warning');
                        }                        
                    } else {
                        unitInput[unitInputI++] = $(this).val();
                        $(this).closest('.unitInputDiv').removeClass('has-success');
                ...
                if(!error) {
                    if(inStockError) {
                        swal({
                            title: "Are you sure?",
                            text: "Your product selling quantity is greater than stock quantity",
                            type: "warning",
                            showCancelButton: true,
                            confirmButtonColor: "#DD6B55",
                        ...
                        function(isConfirm) {
                            if(isConfirm) {
                                swal({title:"", timer:1});
                                $.ajax({
                                    url: base_link+'invoice/addProduct',
                                    type: 'POST',
                                    ...
                                    success: function (response) { 
                                        ...
                                        if(r.response == "success") {
                                            ...
                                            setTimeout(function() {
                                                setTimeout(function() {
                                                    toastr.success(" You successfully added new invoice ", "Add Invoive");
                                                }, 1000);
                                            }, 500);
                                            var activityId = activityListId();
                                            var acType = "fa-plus";
                                            ...
                                            $.ajax({
                                                url: base_link+'recent_activity/add_activity/',
                                                data: 'systemId=bcs'+activityId+ '&userId='+userId+ '&workType=create'+ '&title=invoice'+ '&type='+ acType + '&label='+ acLabel + '&fullLink=invoice/viewInvoice/'+totalPurchase,
                                                type: "POST",
												dataType: 'json',
												contentType: 'json',
                                                success: function(json) {
                                            ...
                                            setTimeout(function(){
                                                $('#sample_10').dataTable().fnAddData( 
                                                    [ 
                                                        ...
                                                        '<div class="btn-group" style="margin: -5px">'+
                                                            ...
                                                            '<ul class="dropdown-menu dropdown-menu-custom btn-group-circle" role="menu">'+
                                                                '<li id="view"'+totalPurchase+'>'+
                                                                    '<a href="'+base_link+'invoice/viewInvoice/'+totalPurchase+'"><i class="fa fa-search" style="color: #26C281;"></i><span>View</span></a>'+
                                                                '</li>'+                                                    
                                                                '<li>'+
                                                                    '<a href="'+base_link+'invoice/viewInvoice/'+totalPurchase+'/history" class="liveLink"><i class="fa fa-history" style="color: gray;"></i><span>History</span></a>'+
                                                                '</li>'+
                                                                ...
                                                                '<li id="print"'+totalPurchase+'>'+
                                                                    '<a href="'+base_link+'invoice/printInvoice/'+totalPurchase+'"><i class="fa fa-print" style="color: #000000;"></i><span>Print</span></a>'+
                                                                '</li>'+
                                                        ...
                                                        '</div>',
                                                        typeStatus+
                                                        '<span id="date'+totalPurchase+'" style="display:none;"">'+$("#invoiceDate").val()+'</span>'+
                                                                            ...
                                                                            '<div id="sysfrm_ajaxrender">'+
                                                                                '<section class="activity-post mb-xlg">'+
                                                                                    '<form id="commentForm'+totalPurchase+'">'+
                                                                                        ...
                                                                                        '<input id="commentType'+totalPurchase+'" name="commentType'+totalPurchase+'" value="invoice" type="hidden">'+
                                                                                    ...
                                                                                    '<div class="compose-box-footer">'+
                                                                                        ...
                                                                                        '<ul class="compose-btn">'+
                                                                                            '<li>'+
                                                                                                '<a class="save'+totalPurchase+' btn btn-success btn-xs" onClick="commentProcess(\'sample_10\', '+totalPurchase+')"><i class="fa fa-edit"></i> Add Note</a>'+
                                                                                            '</li>'+
                                                                                            '<li>'+
                                                ...
                                                swal({
                                                    title: "Created!",
                                                    text: "Invoice created with short of stock.",
                                                    timer: 3000,
                                                    type : "success",
                                                    showConfirmButton: false
                                                });
                                                $('.countInvoices').text(++countInvoices);
                                                $('#sample_10 tbody tr:first').attr('id');
                                                $('#sample_10 tbody tr:first').attr('id','receipt'+totalPurchase);
                                                $('#sample_10 tr td:last-child').css('display', 'none');
                                                $('.addPurchase').stop(true, true).fadeOut({ duration: 1000, queue: false }).slideUp(1000);
            ...
            $('#purchaseUpdate').live('click', function(e) {
                ...
                var type = '';
                if($('input[name="radio6"]:checked', '#addProduct').val() == 'local') {
                    type = '<span class="label label-sm label-warning"> Local </span>';
                } else {
                    type = '<span class="label label-sm label-success"> Foreign </span>';
                }
                var typeStock = '<span class="label label-sm" style="background: #C49F47"> Not Adjust </span>';
                    ...
                    if(inStockError) {
                        ...
                        function(isConfirm) {
                            if(isConfirm) {
                                swal({title:"", timer:1});
                                $.ajax({
                                    url: base_link+'invoice/updateProduct',
                                    type: 'POST',
                                    data: $('#addProduct').serialize(),
                                    async: false,
                                    beforeSend: function() {
                                    ...
                                    success: function (response) { 
                                        ...
                                        if(r.response == "success") {
                                            ...
                                            var currentDue = 0;
                                            if(currencyCheck == "foreign") {
                                                if(parseFloat($('#purchaseTotal').val()) > parseFloat($('#purchaseTotalOld').val())) {
                                                    currentDue = '<a class="tooltipC">'+
                                                                    '<span> '+currencyForeign[1]+" "+parseFloat(parseFloat($('#purchaseTotal').val())-parseFloat($('#purchaseTotalOld').val())+parseFloat($('#purchaseDueAmount').val())).toFixed(2)+' </span>'+
                                                                    '<span class="sTooltip"><strong>'+currencyLocal[1]+" "+parseFloat((parseFloat($('#purchaseTotal').val())-parseFloat($('#purchaseTotalOld').val())+parseFloat($('#purchaseDueAmount').val()))*parseFloat($('#currencyRate').val())).toFixed(2)+'</strong></span>'+
                                                                '</a>';
                                                } else {
                                                    currentDue = '<a class="tooltipC">'+
                                                                    '<span> '+currencyForeign[1]+" "+$('#purchaseTotal').val()+' </span>'+
                                                ...
                                                if(parseFloat($('#purchaseTotal').val()) > parseFloat($('#purchaseTotalOld').val())) {
                                                    currentDue = currencyLocal[1]+" "+parseFloat(parseFloat($('#purchaseTotal').val())-parseFloat($('#purchaseTotalOld').val())+parseFloat($('#purchaseDueAmount').val())).toFixed(2);
                                                } else {
                                                    currentDue = currencyLocal[1]+" "+parseFloat($('#purchaseTotal').val()).toFixed(2);
                                                }
                                            }
                                            setTimeout(function(){
                                                $('#receipt'+id).closest('tr').find('td:eq(2) #date'+id).text($("#invoiceDate").val());
                                                $('#receipt'+id).closest('tr').find('td:eq(2) #title'+id).text($("#title").val());
                                                $('#receipt'+id).closest('tr').find('td:eq(2) #member'+id).text(r.customer);
                                                $('#receipt'+id).closest('tr').find('td:eq(2) #invoiceNo'+id).text($("#invoiceNo").val());
                                                $('#receipt'+id).closest('tr').find('td:eq(2) #poOptional'+id).text($("#poOptional").val());
                                                $('#receipt'+id).closest('tr').find('td:eq(2) #invoiceDate'+id).text($("#invoiceDate").val());
                                                $('#receipt'+id).closest('tr').find('td:eq(2) #pickDate'+id).text($("#pickDate").val());
                                                $('#receipt'+id).closest('tr').find('td:eq(2) #discountType'+id).text($('input[name="radio2"]:checked', '#addProduct').val());
                                                $('#receipt'+id).closest('tr').find('td:eq(2) #discountRate'+id).text($("#discountCheck").val());
                                                $('#receipt'+id).closest('tr').find('td:eq(2) #currencyType'+id).text($('input[name="radio6"]:checked', '#addProduct').val());
                                                $('#receipt'+id).closest('tr').find('td:eq(2) #note'+id).text($(".noteProduct").val());
                                                $('#receipt'+id).closest('tr').find('td:eq(2) #currencyRate'+id).text($("#currencyRate").val());
                                                $('#receipt'+id).closest('tr').find('td:eq(2) #allData'+id).text(allData);
                                                // $('#receipt'+id).closest('tr').find('td:eq(3)').html(typeStock);
                                                $('#receipt'+id).closest('tr').find('td:eq(4)').html(totalRate);
                                                $('#receipt'+id).closest('tr').find('td:eq(5)').html(currentDue); 
                                                $('#receipt'+id).closest('tr').find('td:eq(6)').html(type); 
                                                $('#receipt'+id).closest('tr').find('td:eq(7)').text(r.customer); 
                                                ...
                                                $('#paidCalculate').text(amountCalculate[1]);
                                                purchaseListId(); 
                                                location.replace(base_link+'invoice');
                                            }, 2000);
                                        } else {
                                            if(r.response == 'formManipulation') {
                                                sweetAlert("Oops...", "Why you manipulate system.", "error");                                   
            ...
            $('.noteSubmit').live('click', function(e) {
                $.ajax({
                        url: base_link+'invoice/updateNotePurchase',
                        type: 'POST',
                        ...
                        success: function (response) { 
                            ...
                            if(r.response == "success") {
                                ...
                                $.ajax({
                                    url: base_link+'recent_activity/add_activity/',
                                    data: 'systemId=bcs'+activityId+ '&userId='+userId+ '&workType=update'+ '&title=invoice note'+ '&type='+ acType + '&label='+ acLabel + '&fullLink=invoice/viewInvoice/'+totalPurchase,
                                    type: "POST",
                                    dataType: 'json',
                                    contentType: 'json',
                                    success: function(json) {
            ...
            function removeLogo(id) {
                if($('#logoName').text() == '') {
                    ...
                    $.ajax({
                        url: base_link+'invoice/removeFile',
                        type: 'POST',
            ...
            function updateAttachFile() {
                $.ajax({
                    url: base_link+'invoice/updateAttachFile',
                    type: 'POST',
            ...
            function removeAll() {
                $.ajax({
                    url: base_link+'invoice/removeAll',
                    type: 'POST',
                    ...
                    success: function (response) { 
                        window.location = base_link+'invoice/removeAll/'+$('#purchasefiles').val()+'/'+$('#purchaseEditId').val();
                    }, 
                    error: function(jqXHR, exception) {
                        if (jqXHR.status === 0) {
                            sweetAlert("Oops...", "Not connect. Verify Network.", "error");
            ...
            function downloadAll() {
                $.ajax({
                    url: base_link+'invoice/downloadAllZip',
                    type: 'POST',
                    data: 'file='+$('#purchasefiles').val(),
                    beforeSend: function() {
                        $('#overlay').css('display', 'block');
                    ...
                    success: function (response) { 
                        window.location = base_link+'invoice/downloadAllZip/'+$('#purchasefiles').val();
                    }, 
                    error: function(jqXHR, exception) {
                        if (jqXHR.status === 0) {
                            sweetAlert("Oops...", "Not connect. Verify Network.", "error");
            ...
            $(".radioChange").on('change', function (e) {
                if($('input:radio[name=radio4]:checked').val() == "Monthly"){
                    $('#installmentText').text("Months");
                } else if($('input:radio[name=radio4]:checked').val() == "Weekly"){
                    $('#installmentText').text("Weeks");
                } else {
                    $('#installmentText').text("Days");
                }
            });
                                                                ...
                                                                '<div class="row">'+
                                                                    ...
                                                                    '<div class="col-xs-10 content no-top-border myPermission">'+
                                                                        '<div class="allAccess">'+
                                                                            ...
                                                                            '<i onclick="editComment(\'invoice\', '+id+', '+r.commentId+')" class="fa fa-edit permission iconEdit iconMark"></i>'+
