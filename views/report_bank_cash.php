										...
										<div id="portlet-body" class="portlet-body">
                                            <div style="text-align: center; margin: 10px 0px 25px 0px;">
                                                ...
                                                <span style="font-weight: normal; font-size: 18px; color: gray">
                                                    <?php echo $dataId[0]->type; ?> Balance                                                    
                                                </span><br/>
                                            ...
                                            <div class="table-scrollable">
                                                <table id="table-pagination" class="table table-striped table-hover green">
                                                    <thead>
                                                        <tr style="background-color: #4A86E8; color: #FFFFFF">
                                                            <th> # </th>
                                                            <th> Account </th>
                                                    ...
                                                    <tbody>
                                                        <?php $i = 1; $total = 0; foreach ($details as $detail) { ?>
                                                        <tr>
                                                            <td> <?php echo $i++; ?> </td>
                                                            <td> <?php echo $detail->title ?> </td>
                                                            <td style="text-align: right"> 
                                                                <?php 
                                                                    $dataIncomeReceipt = $this->data_model->columnSum('amount', array('docType' => 'Transaction', 'type' => 'Income', 'account' => $detail->id, 'status' => 1), 'list_transaction');
                                                                    $dataExpenseReceipt = $this->data_model->columnSum('amount', array('docType' => 'Transaction', 'type' => 'Expense', 'account' => $detail->id, 'status' => 1), 'list_transaction');
                                                                    $dataIncomeDocument = $this->data_model->columnSum('adjustAmount', array('type' => 'Income', 'bankId' => $detail->id, 'status' => 1), 'list_payment');
                                                                    $dataExpenseDocument = $this->data_model->columnSum('adjustAmount', array('type' => 'Expense', 'bankId' => $detail->id, 'status' => 1), 'list_payment');
                                                                    ...
                                                                    echo number_format($detail->balance+$dataIncomeReceipt[0]->amount+$dataIncomeDocument[0]->adjustAmount-($dataExpenseReceipt[0]->amount+$dataExpenseDocument[0]->adjustAmount), 2);
                                                                ?>
