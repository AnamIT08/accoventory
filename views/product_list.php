...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Purchase | Accoventory .::.SaaS.::. Accounting & Inventory Software - SaaS</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md  pace-done">
                                                ...
                                                <div class="col-sm-10 newDrop pull-left">
                                                    <form action="<?php echo base_url(); ?>product/file_upload/" class="dropzone dropzone-file-area">                                                                
                                                        ...
                                                        <div class="uploadFirst uploadFirstFile">
                                                            ...
                                                            <div class="wave-logo-uploader-dropzone__logo___dropzone__text"><span class="wv-text wv-text--body"><span class="wave-logo-uploader-dropzone__logo__dropzone__browse-link">Browse</span><span> </span><span> related files here.</span></span></div>
                                            ...
                                            <div class="row"> 
                                                <div class="col-sm-offset-1 pull-right col-sm-5">
                                                    <div class="row">                                                        
                                                        <div id="purchaseLogo" class="col-sm-11 col-sm-offset-1 pull-left newDrop" style="display: <?php if($basicInvoiceEstimate[0]->defaultLogoSettings != "No" && $basicSettings[0]->bDefaultLogo == "") { echo "block"; } else { echo "none"; } ?>;">
                                                            <form action="<?php echo base_url(); ?>product/file_upload/" class="dropzone dropzone-file-area">                                                                
                                                                ...
                                                                <div class="uploadFirst">
                                                                    <div class="fadeMe"></div>                                                            
                                                                    <img class="wave-logo-uploader-dropzone__logo__dropzone__icon" src="<?php echo base_url(); ?>assets/uploadedFile/system/63cc4065e830c9f2e76f19ff398dc73d.svg">
                                                                    <div class="wave-logo-uploader-dropzone__logo___dropzone__text"><span class="wv-text wv-text--body"><span class="wave-logo-uploader-dropzone__logo__dropzone__browse-link">Browse</span><span> </span><span> vendor logo/picture here.</span></span></div>
                                                                    <div class="wave-logo-uploader-dropzone__logo__dropzone__hint"><span class="wv-text wv-text--hint"><span>Maximum 500KB in size.</span><br ><span>JPG, PNG, or GIF formats.</span></span></div>
                                                                    <div class="wave-logo-uploader-dropzone__logo__dropzone__hint"><span class="wv-text wv-text--hint">Recommended size: 300 x 200 pixels.</span></div>
                                                                </div>
                                                            </form>
                                                        ...
                                                        <div id="uploadFileBtn" class="col-sm-offset-1 col-sm-11" style="font-size: 35px; margin: 15px; cursor: pointer; z-index: 10; line-height: 10px;">
                                                            <div class=" pull-right">
                                                                <span><i class="fa fa-cloud-upload" style="float: right;"></i></span><br/>
                                                                <span style="font-size: 14px; float: right;"><br/>Upload related files</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>                              
                                                <form id="addProduct" role="form" action="#">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="col-md-offset-1 col-md-11">
                                                            <div id="titleDiv" class="form-group form-md-line-input">
                                                                <input id="title" class="form-control" placeholder="Bill (Optional)" name="title" type="text" value="<?php echo $basicInvoiceEstimate[0]->titlePurchase; ?>" style="font-size: 20px" />
                                                            ...
                                                            <div class="new-customer-data" style="display:none">
                                                                <div class="form-group form-group-condensed">
                                                                    <div id="customer_emailDiv" class="form-group form-md-line-input">
                                                                        <input id="customer_email" class="form-control customFormControl" placeholder="Vendor Email (required)" name="customer_email" type="text">
                                                                        <div class="form-control-focus"> </div>
                                                                    </div>
                                                    ...
                                                    <div class="row">                                              
                                                        ...
                                                        <div class="col-sm-offset-1 col-sm-5 fileList" style="display: none;">
                                                            <ul class="dd-list">
                                                                <li class="dd-item dd3-item has-sub ui-sortable-handle removeAll" style="display: none;">
                                                                    <div class="dd3-content">
                                                                        Remove All                                                                    
                                                                        <i class="deleteFileIcon fa fa-times-circle-o" style="color: red !important" onclick="removeAll()"></i>
                                                                    </div>
                                                                </li> 
                                                                <li class="dd-item dd3-item has-sub ui-sortable-handle downloadAll" style="display: none;">
                                                                    <div class="dd3-content">
                                                                        Download All                                                                    
                                        ...
                                        <div style="float: right;">
                                            ...
                                            <?php 
                                                ...
                                                if(in_array(10, $menus)) {
                                                    echo   '<a href="'.base_url().'settings/others/Product" class="btn yellow-haze btn-sm"><i class="fa fa-plus"></i> Add Product </a>';
                                                }
                                            ?>
                                        </div>
                                    </div>
                                        ...
                                        <div class="portlet-title" style="padding-left:1.5%; padding-right:1.5%">
                                            ...
                                            <div class="actions">
                                                <div class="btn-group btn-group-solid">
                                                    ...
                                                    <a class="dt-button buttons-print btn dark btn-outline" onclick="printData('sample_1', 'Purchase List Active')"><i class="fa fa-print"></i><span>Print</span></a>
                                            ...
                                            <table class="table table-striped table-bordered table-hover dt-responsive" id="sample_1">
                                                ...
                                                <tbody class="uiSortableList">
                                                    <?php foreach ($activePurchase as $activePurchaseResult) {
                                                        $allComments = $this->data_model->get_all_info('*', array('docType' => 'purchase', 'docId' => $activePurchaseResult->id), 'list_all_comment');
                                                    ?>
                                                    <tr id="receipt<?php echo $activePurchaseResult->id; ?>">
                                                            ...
                                                            <div class="btn-group" style="margin: -5px">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-custom btn-group-circle" role="menu" style="position: absolute;">
                                                                    <li id="view<?php echo $activePurchaseResult->id; ?>">
                                                                        <a target="_blank" href="<?php echo base_url(); ?>product/viewBill/<?php echo $activePurchaseResult->id; ?>" class="liveLink"><i class="fa fa-search" style="color: #26C281;"></i><span>View</span></a>
                                                                    </li>
                                                                    <li id="history<?php echo $activePurchaseResult->id; ?>">
                                                                        <a target="_blank" href="<?php echo base_url(); ?>product/viewBill/<?php echo $activePurchaseResult->id; ?>/history" class="liveLink"><i class="fa fa-history" style="color: gray;"></i><span>History</span></a>
                                                                    </li>
                                                                    ...
                                                                    <li id="print<?php echo $activePurchaseResult->id; ?>">
                                                                        <a target="_blank" href="<?php echo base_url(); ?>product/printBill/<?php echo $activePurchaseResult->id; ?>" class="liveLink"><i class="fa fa-print" style="color: #000000;"></i><span>Print</span></a>
                                                                    </li>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span id="remarks<?php echo $activePurchaseResult->id; ?>" style="display:none;"><?php echo $activePurchaseResult->remarks; ?></span>
                                                        ...
                                                        <td>
                                                            <?php 
                                                                ...
                                                                if($activePurchaseResult->currencyType == 'local') {
                                                                    $currencySysmbol = explode("-", $basicSettings[0]->currencySymbol);
                                                                    echo $currencySysmbol[1]." ".number_format($activePurchaseResult->calculateTotalLocal, 2);
                                                                } else {
                                                        ...
                                                        <td>
                                                            <?php 
                                                                ...
                                                                if($activePurchaseResult->currencyType == 'local') {
                                                                    $currencySysmbol = explode("-", $basicSettings[0]->currencySymbol);
                                                                    echo $currencySysmbol[1]." ".number_format($activePurchaseResult->calculateTotalLocal - $purchasePaid, 2);
                                                                } else {
                                                                    $currencySysmbol = explode("-", $basicSettings[0]->foreignCurrencySymbol);
                                                                    echo $currencySysmbol[1];
                                                                    echo    '<a class="tooltipC">
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="label label-sm label-warning"> Local </span>
                                                            <?php } else { ?>
                                                            <span class="label label-sm label-success"> Foreign </span>
                                                            <?php } ?>
                                                        </td>
                                                        <td>
                                                                                ...
                                                                                <div id="sysfrm_ajaxrender">
                                                                                    <section class="activity-post mb-xlg">
                                                                                        <form id="commentForm<?php echo $activePurchaseResult->id; ?>">
                                                                                            ...
                                                                                            <input id="commentType<?php echo $activePurchaseResult->id; ?>" name="commentType<?php echo $activePurchaseResult->id; ?>" value="purchase" type="hidden">
                                                                                                        ...
                                                                                                        <div class="col-xs-10 content no-top-border myPermission">
                                                                                                            <div class="allAccess">
                                                                                                                ...
                                                                                                                <?php if($this->session->userdata('id') == $comment->createdBy) { ?>
                                                                                                                    <i onclick="editComment('purchase', <?php echo $activePurchaseResult->id; ?>, <?php echo $comment->id; ?>)" class="fa fa-edit permission iconEdit iconMark"></i>
                                                                                                                    <i onclick="deleteComment('sample_1', <?php echo $activePurchaseResult->id; ?>, <?php echo $comment->id; ?>)" class="fa fa-trash permission iconDelete iconMark"></i>
                                                                                                                <?php } ?>
                                                                                                            </div>
                                        ...
                                        <div class="portlet-title" style="padding-left:1.5%; padding-right:1.5%">
                                            ...
                                            <div class="actions">
                                                <div class="btn-group btn-group-solid">
                                                    <!-- <a id="cPage" class="dt-button buttons-print btn gray btn-outline"><i class="fa fa-plus-square-o" style="color: #555555;"></i><span>Current Page</span></a>
                                                    <a id="tTable" class="dt-button buttons-print btn gray btn-outline"><i class="fa fa-plus-square" style="color: #555555;"></i><span>Total Table</span></a> -->
                                                    <a class="dt-button buttons-print btn dark btn-outline" onclick="printData('sample_11', 'Purchase List Inactive')"><i class="fa fa-print"></i><span>Print</span></a>
                                            ...
                                            <table class="table table-striped table-bordered table-hover dt-responsive" id="sample_11">
                                                ...
                                                <tbody class="uiSortableList">
                                                    <?php foreach ($inActivePurchase as $inActivePurchaseResult) {
                                                        $allComments = $this->data_model->get_all_info('*', array('docType' => 'purchase', 'docId' => $inActivePurchaseResult->id), 'list_all_comment');
                                                    ?>
                                                    <tr id="receipt<?php echo $inActivePurchaseResult->id; ?>">
                                                            ...
                                                            <div class="btn-group" style="margin: -5px">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-custom btn-group-circle" role="menu" style="position: absolute;">
                                                                    <li id="view<?php echo $inActivePurchaseResult->id; ?>">
                                                                        <a target="_blank" href="<?php echo base_url(); ?>product/viewBill/<?php echo $inActivePurchaseResult->id; ?>" class="liveLink"><i class="fa fa-search" style="color: #26C281;"></i><span>View</span></a>
                                                                    </li>
                                                                    <li id="history<?php echo $inActivePurchaseResult->id; ?>">
                                                                        <a target="_blank" href="<?php echo base_url(); ?>product/viewBill/<?php echo $inActivePurchaseResult->id; ?>/history" class="liveLink"><i class="fa fa-history" style="color: gray;"></i><span>History</span></a>
                                                                    </li>
                                                                    <li id="print<?php echo $inActivePurchaseResult->id; ?>">
                                                                        <a target="_blank" href="<?php echo base_url(); ?>product/printBill/<?php echo $inActivePurchaseResult->id; ?>" class="liveLink"><i class="fa fa-print" style="color: #000000;"></i><span>Print</span></a>
                                                                    </li>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span id="invoiceDate<?php echo $inActivePurchaseResult->id; ?>" style="display:none;"><?php echo $inActivePurchaseResult->date; ?></span>
                                                            <span id="pickDate<?php echo $inActivePurchaseResult->id; ?>" style="display:none;"><?php echo $inActivePurchaseResult->dueDate; ?></span>
                                                            ...
                                                            <span id="remarks<?php echo $inActivePurchaseResult->id; ?>" style="display:none;"><?php echo $inActivePurchaseResult->remarks; ?></span>
                                                        ...
                                                        <td>
                                                            <?php 
                                                                ...
                                                                if($inActivePurchaseResult->currencyType == 'local') {
                                                                    $currencySysmbol = explode("-", $basicSettings[0]->currencySymbol);
                                                                    echo $currencySysmbol[1]." ".number_format($inActivePurchaseResult->calculateTotalLocal, 2);
                                                                } else {
                                                                    $currencySysmbol = explode("-", $basicSettings[0]->foreignCurrencySymbol);
                                                                    echo $currencySysmbol[1];
                                                                    echo    '<a class="tooltipC">
                                                        ...
                                                        <td>
                                                            <?php 
                                                                ...
                                                                if($inActivePurchaseResult->currencyType == 'local') {
                                                                    $currencySysmbol = explode("-", $basicSettings[0]->currencySymbol);
                                                                    echo $currencySysmbol[1]." ".number_format($inActivePurchaseResult->calculateTotalLocal - $purchasePaid, 2);
                                                                } else {
                                                                    $currencySysmbol = explode("-", $basicSettings[0]->foreignCurrencySymbol);
                                                                    echo $currencySysmbol[1];
                                                                    echo    '<a class="tooltipC">
                                                                                ...
                                                                                <div id="sysfrm_ajaxrender">
                                                                                    <section class="activity-post mb-xlg">
                                                                                        <form id="commentForm<?php echo $inActivePurchaseResult->id; ?>">
                                                                                            ...
                                                                                            <input id="commentType<?php echo $inActivePurchaseResult->id; ?>" name="commentType<?php echo $inActivePurchaseResult->id; ?>" value="purchase" type="hidden">
                                                                                                    ...
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div class="col-xs-10 content no-top-border myPermission">
                                                                                                            <div class="allAccess">
                                                                                                                <i class="fa<?php echo $comment->id; ?> fa <?php echo $comment->commentIcon; ?> iconMark"></i>
                                                                                                                <?php if($this->session->userdata('id') == $comment->createdBy) { ?>
                                                                                                                    <i onclick="editComment('purchase', <?php echo $inActivePurchaseResult->id; ?>, <?php echo $comment->id; ?>)" class="fa fa-edit permission iconEdit iconMark"></i>
                                                                                                                    <i onclick="deleteComment('sample_11', <?php echo $inActivePurchaseResult->id; ?>, <?php echo $comment->id; ?>)" class="fa fa-trash permission iconDelete iconMark"></i>
                                                                                                                <?php } ?>
                                                                                                            </div>
                                                                                                            <p class="m-b-xs"><strong><?php echo $team[0]->name; ?></strong></p>
                                                                                                            <p class="text<?php echo $comment->id; ?>"><?php echo $comment->comments ?></p>
        ...
        <script type="text/javascript"> 
            ...
            var countProducts = <?php echo $countProduct; ?>;
        </script>
        ...
        <script>
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if(currencyCheck == "foreign") {
                                    ...
                                    $('.'+trRowId).closest('tr').find('.pricePInput').val(r.lastPurchasePrice);
                                }
            ...
            function editData(id) {
                ...
                for (var i = 0; i< fileAll.length; i++) {
                    ...
                    var liHtml =  '<li id="attachFileLive'+fileExt[0]+'" class="dd-item dd3-item has-sub ui-sortable-handle">'+
                                  '<div class="dd3-content">'+
                                      '<a href="<?php echo base_url(); ?>assets/uploadedFile/files/'+fileAll[i]+'" class="fancybox-button" data-rel="fancybox-button">Attached '+fileExt[1]+' File</a>'+
            ...
            function deleteData(id) {
                ...
                function(isConfirm){
                    ...
                    if (isConfirm) {
                        ...
                        $.ajax({
                            type: 'post',
                            url: base_link + "product/productStatus",
                            data: 'id='+ id + '&status=' + 0,
                            success: function(response) {
                                r = $.parseJSON(response);
                                if(r.response == "success") {
                                    ...
                                    setTimeout(function() {
                                        setTimeout(function() {
                                            $('.countProducts').text(--countProducts);
                                            ...
                                            toastr.error(" You successfully archive bill ", "Archive Bill");
                                        }, 1500);
                                        swal({
                                            title: "Archive!",
                                            text: "This bill has been archived.",
                                            timer: 3000,
                                            type : "success",
                                    ...
                                    $.ajax({
                                        ...
                                        data: 'systemId=bcra'+activityId+ '&userId='+userId+ '&workType=archive'+ '&title=bill'+ '&type='+ acType + '&label='+ acLabel + '&fullLink=settings',
                                        type: "POST",
										dataType: 'json',
										contentType: 'json',
                                ...
                                if(r.response == "success") {
                                    ...
                                    setTimeout(function() {
                                        setTimeout(function() {
                                            ...
                                            toastr.success(" You successfully active bill ", "Active Bill");
                                            //re-initialize fancybox    
                                            $('.fancybox-button').fancybox();
                                        }, 1500);
                                        swal({
                                            title: "Activate!",
                                            text: "This bill has been activate.",
                                            timer: 3000,
                                            type : "success",
                                            showConfirmButton: false
                                        });
                                    ...
                                    $.ajax({
                                        url: base_link+'recent_activity/add_activity/',
                                        data: 'systemId=bcra'+activityId+ '&userId='+userId+ '&workType=active'+ '&title=bill'+ '&type='+ acType + '&label='+ acLabel + '&fullLink=settings',
                                        type: "POST",
										dataType: 'json',
										contentType: 'json',
                                        success: function(json) {
            ...
            $('#purchaseSave').live('click', function(e) {
                ...
                if(new_customer != '') {
                    ...
                    if(!validateEmail(userValue)) {
                        ...
                        $.post(base_link+"vendor/live_email", {
                            email: userValue
                        }, function(response){
                            if(response == 'exist') {                        
                                $('#customer_emailDiv').removeClass('has-success');
                    ...
                    $.ajax({
                        ...
                        success: function (response) { 
                            ...
                            if(r.response == "success") {
                                ...
                                setTimeout(function() {
                                    setTimeout(function() {
                                        toastr.success(" You successfully added new bill ", "Add Bill");
                                    }, 1000);
                                }, 500);
                                var activityId = activityListId();
                                var acType = "fa-plus";
                                ...
                                $.ajax({
                                    url: base_link+'recent_activity/add_activity/',
                                    data: 'systemId=bcs'+activityId+ '&userId='+userId+ '&workType=create'+ '&title=bill'+ '&type='+ acType + '&label='+ acLabel + '&fullLink=product/viewBill/'+totalPurchase,
                                    type: "POST",
                                    dataType: 'json',
                                    contentType: 'json',
                                    success: function(json) {
                                            ...
                                            '<div class="btn-group" style="margin: -5px">'+
                                                ...
                                                '<ul class="dropdown-menu dropdown-menu-custom btn-group-circle" role="menu">'+
                                                    '<li id="view"'+totalPurchase+'>'+
                                                        '<a href="'+base_link+'product/viewBill/'+totalPurchase+'"><i class="fa fa-search" style="color: #26C281;"></i><span>View</span></a>'+
                                                    '</li>'+                                                    
                                                    '<li>'+
                                                        '<a href="'+base_link+'product/viewBill/'+totalPurchase+'/history" class="liveLink"><i class="fa fa-history" style="color: gray;"></i><span>History</span></a>'+
                                                    '</li>'+
                                                    ...
                                                    '<li id="print"'+totalPurchase+'>'+
                                                        '<a href="'+base_link+'product/printBill/'+totalPurchase+'"><i class="fa fa-print" style="color: #000000;"></i><span>Print</span></a>'+
                                                    '</li>'+
                                                                ...
                                                                '<div id="sysfrm_ajaxrender">'+
                                                                    '<section class="activity-post mb-xlg">'+
                                                                        '<form id="commentForm'+totalPurchase+'">'+
                                                                            ...
                                                                            '<input id="commentType'+totalPurchase+'" name="commentType'+totalPurchase+'" value="purchase" type="hidden">'+
            ...
            $('#purchaseUpdate').live('click', function(e) {
                ...
                if(!error) {
                    $.ajax({
                        url: base_link+'product/updateProduct',
                        type: 'POST',
                        data: $('#addProduct').serialize(),
                        async: false,
                        beforeSend: function() {
                        ...
                        success: function (response) { 
                            ...
                            if(r.response == "success") {
                                ...
                                setTimeout(function() {
                                    setTimeout(function() {
                                        toastr.success(" You successfully update bill ", "Add Bill");
                                    }, 1000);
                                }, 500);
                                var activityId = activityListId();
                                var acType = "fa-plus";
                                ...
                                $.ajax({
                                    url: base_link+'recent_activity/add_activity/',
                                    data: 'systemId=bcs'+activityId+ '&userId='+userId+ '&workType=edit'+ '&title=bill'+ '&type='+ acType + '&label='+ acLabel + '&fullLink=product/viewBill/'+totalPurchase,
                                    type: "POST",
                                    dataType: 'json',
                                    contentType: 'json',
                                    success: function(json) {
                                ...
                                setTimeout(function(){
                                    ...
                                    $('#receipt'+id).closest('tr').find('td:eq(3)').text($("#invoiceNo").val());
                    ...
                    $.ajax({
                        ...
                        success: function (response) { 
                            ...
                            if(r.response == "success") {
                                ...
                                setTimeout(function() {
                                    setTimeout(function() {
                                        toastr.success(" You successfully update bill ", "Update Bill");
                                    }, 1000);
                                }, 500);
                                var activityId = activityListId();
                                var acType = "fa-plus";
                                ...
                                setTimeout(function(){
                                    ...
                                    $('#receipt'+id).closest('tr').find('td:eq(2) #allData'+id).text(allData);
                                    $('#receipt'+id).closest('tr').find('td:eq(3)').text($("#invoiceNo").val());
                                    $('#receipt'+id).closest('tr').find('td:eq(4)').text(totalRate);
                                    $('#receipt'+id).closest('tr').find('td:eq(5)').html(currentDue);
                                    $('#receipt'+id).closest('tr').find('td:eq(6)').html(type); 
                                    $('#receipt'+id).closest('tr').find('td:eq(7)').text(r.customer); 
                                    $('#receipt'+id).closest('tr').find('td:eq(8)').text(userNameFull); 
                ...
                $.ajax({
                        ...
                        success: function (response) { 
                            ...
                            if(r.response == "success") {
                                ...
                                setTimeout(function() {
                                    setTimeout(function() {
                                        toastr.success(" You successfully update bill note", "Update Bill Note");
                                    }, 1000);
                                }, 500);
                                var activityId = activityListId();
                                var acType = "fa-plus";
                                ...
                                $.ajax({
                                    url: base_link+'recent_activity/add_activity/',
                                    data: 'systemId=bcs'+activityId+ '&userId='+userId+ '&workType=update'+ '&title=bill note'+ '&type='+ acType + '&label='+ acLabel + '&fullLink=product/viewBill/'+totalPurchase,
                                    type: "POST",
                                    dataType: 'json',
                                    contentType: 'json',
                                    success: function(json) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) { 
                            ...
                            if(r.response == "success") {
                                ...
                                setTimeout(function() {
                                    setTimeout(function() {
                                        toastr.success(" You successfully remove bill logo", "Remove Bill Logo");
                                    }, 1000);
                                }, 500);        
                                $('.purchaseLogoDiv').slideUp(1000);
                                $('#purchaseLogo').delay(1200).slideDown();  
                                ...
                                $.ajax({
                                    url: base_link+'recent_activity/add_activity/',
                                    data: 'systemId=bcs'+activityId+ '&userId='+userId+ '&workType=remove'+ '&title=bill logo'+ '&type='+ acType + '&label='+ acLabel + '&fullLink=product/viewBill/'+totalPurchase,
                                    type: "POST",
                                    dataType: 'json',
                                    contentType: 'json',
                                    success: function(json) {
                ...
                $.ajax({
                    ...
                    success: function (response) { 
                        ...
                        if(r.response == "success") {
                            ...
                            setTimeout(function() {
                                setTimeout(function() {
                                    toastr.success(" You successfully remove files", "Remove File");
                                }, 1000);
                            }, 500);               
                            $('#'+liId).remove(); 
                            ...
                            $.ajax({
                                url: base_link+'recent_activity/add_activity/',
                                data: 'systemId=bcs'+activityId+ '&userId='+userId+ '&workType=delete'+ '&title=remove file'+ '&type='+ acType + '&label='+ acLabel + '&fullLink=product/viewBill/'+totalPurchase,
                                type: "POST",
								dataType: 'json',
								contentType: 'json',
                                success: function(json) {
            ...
            function updateAttachFile() {
                $.ajax({
                    url: base_link+'product/updateAttachFile',
                    type: 'POST',
            ...
            function removeAll() {
                $.ajax({
                    url: base_link+'product/removeAll',
                    type: 'POST',
                    ...
                    success: function (response) { 
                        window.location = base_link+'product/removeAll/'+$('#purchasefiles').val()+'/'+$('#purchaseEditId').val();
                    }, 
                    error: function(jqXHR, exception) {
                        if (jqXHR.status === 0) {
                            sweetAlert("Oops...", "Not connect. Verify Network.", "error");
