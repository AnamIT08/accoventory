<?php
    ...
    $textColor = '';    
    $adjustColor = '';
    //echo $purchaseInfo[0]->paidAmount." > ".$purchaseInfo[0]->calculateTotal; die();
    if($diff > 0) {
        $textColor = '';
        if($purchaseInfo[0]->cStatus == 2) {
            $statusClass = 'ribbonCustomSent'; $status = 'Sent'; $adjustColor = '#ED6B75';
        } else if($purchaseInfo[0]->cStatus == 3) {
            $statusClass = 'ribbonCustomViewed'; $status = 'Viewed'; $adjustColor = '#337AB7';
        } else if($purchaseInfo[0]->cStatus == 4) {
            $statusClass = 'ribbonCustomAccepted'; $status = 'Accepted'; $adjustColor = '#337AB7';
        } else {
            $statusClass = 'ribbonCustomDraft'; $status = 'Draft'; $adjustColor = '#36C6D3';
        }
    } else {
        $textColor = '';
        $statusClass = 'ribbonCustomExpire'; $status = 'Expire'; $adjustColor = '#D91E18';
    }
    $overAdjust = 0;
    $isOk = 0;
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Estimate <?php echo $purchaseInfo[0]->documentId ?> | Accoventory .::.SaaS.::. Accounting & Inventory Software - SaaS</title>
        ...
        <style type="text/css">
            ...
            .ribbonCustomExpire span::before {
                content: "";
            ...
            .ribbonCustomAccepted span::before {
                content: "";
                position: absolute; left: 0px; top: 100%;
                z-index: -1;
            ...
            .ribbonCustomAccepted span::after {
                content: "";
                position: absolute; right: 0px; top: 100%;
                z-index: -1;
                border-left: 3px solid transparent;
            ...
            .ribbonCustomViewed span::before {
                content: "";
                position: absolute; left: 0px; top: 100%;
                z-index: -1;
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md  pace-done">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <!-- BEGIN CONTENT BODY -->
                    ...
                    <div class="row">
                        <div class="col-md-3 pull-right cTsButton" style="z-index: 10000; width: <?php if($purchaseInfo[0]->cStatus != 4) { echo '295px !important'; } else { echo '202px'; } ?>">
                            <div class="BillView" style="padding: 5px;">                                
                                <div class="btn-group" role="group" aria-label="...">
                                    <?php if($purchaseInfo[0]->cStatus != 4) { ?>
                                    <a href="javascript:;" class="btn green btn-sm accepted"><i class="fa fa-file-pdf-o"></i> Accept</a>
                                    <?php } ?>
                                    <a href="<?php echo base_url(); ?>Estimate/pdfEstimate/<?php echo $purchaseInfo[0]->id ?>/view" target="_blank" class="btn yellow-mint btn-sm"><i class="fa fa-file-pdf-o"></i> Pdf</a>
                                    <a href="<?php echo base_url(); ?>Estimate/printEstimate/<?php echo $purchaseInfo[0]->id ?>" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-print"></i> Print</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-9">
                                                                ...
                                                                <?php 
                                                                    ...
                                                                    if($purchaseInfo[0]->currencyType == 'local') {
                                                                        ...
                                                                        echo    '<a class="tooltipC">
                                                                                    <span><span class="dueText">'.number_format(($purchaseInfo[0]->calculateTotal - $purchaseInfo[0]->paidAmount), 2).'</span></span>
                                                                    ...
                                                                    <td class="text-right">
                                                                        <?php 
                                                                            ...
                                                                            if($purchaseInfo[0]->currencyType == 'local') {
                                                                                ...
                                                                                echo $currencySysmbol[1];
                                                                                echo    '<a class="tooltipC">
                                                                                            <span><span class="dueText">'.number_format(($specificTr[3]), 2).'</span></span>
                                                                    ...
                                                                    <td class="text-right">
                                                                        <?php 
                                                                            ...
                                                                            if($purchaseInfo[0]->currencyType == 'local') {
                                                                                ...
                                                                                echo $currencySysmbol[1];
                                                                                echo    '<a class="tooltipC">
                                                                                            <span><span class="dueText">'.number_format(($specificTr[6]), 2).'</span></span>
                                                            ...
                                                            <td class="text-right">
                                                                <?php 
                                                                    ...
                                                                    if($purchaseInfo[0]->currencyType == 'local') {
                                                                        ...
                                                                        echo $currencySysmbol[1];
                                                                        echo    '<a class="tooltipC">
                                                                                    <span><span class="dueText">'.number_format(($subTotal), 2).'</span></span>
                                                                ...
                                                                <?php 
                                                                    if($purchaseInfo[0]->discountAmount != 0.00) { 
                                                                        ...
                                                                        if($purchaseInfo[0]->currencyType == 'local') {
                                                                            ...
                                                                            echo $currencySysmbol[1];
                                                                            echo    '<a class="tooltipC">
                                                                                        <span><span class="dueText">'.number_format(($discount), 2).'</span></span>
                                                                        ...
                                                                        if($purchaseInfo[0]->currencyType == 'local') {
                                                                            ...
                                                                            echo $currencySysmbol[1];
                                                                            echo    '<a class="tooltipC">
                                                                                        <span><span class="dueText">'.number_format((0.00), 2).'</span></span>
                                                            ...
                                                            <td class="text-right">
                                                                <?php 
                                                                    ...
                                                                    if($purchaseInfo[0]->currencyType == 'local') {
                                                                        ...
                                                                        echo $currencySysmbol[1];
                                                                        echo    '<a class="tooltipC">
                                                                                    <span><span class="dueText">'.number_format(($purchaseInfo[0]->calculateTotal), 2).'</span></span>
                                                                                    <span class="sTooltip"><strong>'.$localSymbol." ".number_format($purchaseInfo[0]->calculateTotal*$purchaseInfo[0]->currencyRate, 2).'</strong></span>
                                                                                </a>';
                                                                    }
                                                                ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td id="paidText" class="text-right"> 
                                                                <?php 
                                                                    ...
                                                                    if($purchaseInfo[0]->currencyType == 'local') {
                                                                        $currencySysmbol = explode("-", $basicSettings[0]->currencySymbol);
                                                                        echo $currencySysmbol[1]." ".number_format($purchaseInfo[0]->paidAmount, 2);
                                                                    } else {
                                                                        $currencySysmbol = explode("-", $basicSettings[0]->foreignCurrencySymbol);
                                                                        echo $currencySysmbol[1];
                                                                        echo    '<a class="tooltipC">
                                                                                    <span><span class="dueText">'.number_format(($purchaseInfo[0]->paidAmount), 2).'</span></span>
                                                                                    <span class="sTooltip"><strong>'.$localSymbol." ".number_format($purchaseInfo[0]->paidAmount*$purchaseInfo[0]->currencyRate, 2).'</strong></span>
                                                                                </a>';
                                                                    }
                                                                ?>
                                                            </td>
                        ...
                        <div class="col-md-3">
                            <div class="BillView">
                                ...
                                <ul class="Bill-estimate-history">
                                    <li class="created">
                                        <p style="color: gray;">--- <b>N/A</b> ---</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-offset-9 col-md-3 pull-right bottomButton cTsButton" style="display: none; width: <?php if($purchaseInfo[0]->cStatus != 4) { echo '295px !important'; } else { echo '202px'; } ?>">
                            <div class="BillView" style="padding: 5px;">                                
                                <div class="btn-group" role="group" aria-label="...">                                
                                    <?php if($purchaseInfo[0]->cStatus != 4) { ?>
                                    <a href="javascript:;" class="btn green btn-sm accepted"><i class="fa fa-file-pdf-o"></i> Accept</a>
                                    <?php } ?>
                                    <a href="" target="_blank" class="btn yellow-mint btn-sm"><i class="fa fa-file-pdf-o"></i> Pdf</a>
                                    <a onclick="data_history('print', 'requisition', 'raw_material', '3')" href="<?php echo base_url(); ?>Estimate/printBill" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-print"></i> Print</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script type="text/javascript">
            ...
            $('.accepted').on('click', function (e) {
                $.ajax({
                    url: base_link+'estimate/updateCstatus',
                    type: 'POST',
                    data: 'editId='+<?php echo $this->uri->segment(3) ?>,
                    async: false,
                    beforeSend: function() {
                    ...
                    success: function (response) { 
                        ...
                        if(r.response == "success") {
                            ...
                            var activityId = 'visitor'; //activityListId();
                            var acType = "fa-plus";
                            var acLabel = "label-success";
                            $.ajax({
                                url: base_link+'recent_activity/add_activity/',
                                data: 'systemId=bcs'+activityId+ '&userId='+userId+ '&workType=create'+ '&title=purchase'+ '&type='+ acType + '&label='+ acLabel + '&fullLink=estimate/viewEstimate/'+<?php echo $purchaseInfo[0]->id ?>,
                                type: "POST",
								dataType: 'json',
								contentType: 'json',
                            ...
                            setTimeout(function(){
                               $('.accepted') .slideUp();
                               $('#ribbonCustom').removeClass('ribbonCustomViewed');
                               $('#ribbonCustom').addClass('ribbonCustomAccepted');
                               $('#ribbonCustomText').text('Accepted');
                               $('.cTsButton').removeClass('col-md-3');
                               $('.cTsButton').addClass('col-md-2');
                               $('.cTsButton').css('width', '201px');
                               window.location.href(base_link+"invoice/viewInvoice/"+id);
                            }, 2000);
                        } else {
            ...
            if(userId == '') {
                $.get(base_link+"estimate/statusCustomer/<?php echo $this->uri->segment(3); ?>/Estimate/Viewed",{
                },
