										...
										<div id="portlet-body" class="portlet-body">
                                            ...
                                            <div class="table-scrollable">
                                                <table id="table-pagination" class="table table-striped table-hover green">
                                                    <thead>
                                                        <tr style="background-color: #45818E; color: #FFFFFF">
                                                            <th> # </th>
                                                            <th> Date & Time </th>
                                                            <th> # ID </th>
                                                            <th> Category </th>
                                                    ...
                                                    <tbody>                                                        
                                                        <?php $income = 0; $expense = 0; $i = 1; foreach ($details as $detail) { ?>
                                                            <tr>
                                                                <td> <?php echo $i++; ?> </td>
                                                                ...
                                                                <td> <?php $bank = $this->data_model->get_specific_column("title", array("id" => $detail->account), "settings_bank_account"); echo $bank[0]->title; ?> </td>
                                                                <td style="text-align: right; <?php if($detail->type == "Income") {echo 'color: #26C281;';} else {echo 'color: #FF0000;';} ?> font-weight: bold;">
                                                                    <?php 
                                                        ...
                                                        <tr style="background-color: #e8e8e8">
                                                            ...
                                                            <th style="text-align: right"> 
                                                                <span id="expense" style="color: #FF0000"><?php echo number_format($expense, 2); ?></span> /
                                                                <span id="income" style="color: #26C281"><?php echo number_format($income, 2); ?></span> 
                                                            </th>
                                                        </tr>
                                                    </tbody>
                                                </table>
