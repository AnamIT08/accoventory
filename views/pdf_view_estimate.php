...
<html lang="en">
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md  pace-done">
                                            ...
                                            <span class="special-currency-symbol ">
                                                <?php 
                                                    ...
                                                    if($purchaseInfo[0]->currencyType == 'local') {
                                                        ...
                                                        echo    '<span class="dueText"> '.number_format(($purchaseInfo[0]->calculateTotal - $purchaseInfo[0]->paidAmount), 2).'</span>';
                                                    }
                                                ?>
                                            </span>
                                        </td>
                                                    ...
                                                    <td class="text-right">
                                                        <?php 
                                                            ...
                                                            if($purchaseInfo[0]->currencyType == 'local') {
                                                                ...
                                                                $currencySysmbol = explode("-", $basicSettings[0]->foreignCurrencySymbol);
                                                                echo $currencySysmbol[1];
                                                                echo    '<span class="dueText"> '.number_format(($specificTr[3]), 2).'</span>';
                                                            } 
                                                        ?>
                                                    </td>
                                                    <td class="text-right">
                                                    ...
                                                    <td class="text-right">
                                                        <?php 
                                                            ...
                                                            if($purchaseInfo[0]->currencyType == 'local') {
                                                                ...
                                                                $currencySysmbol = explode("-", $basicSettings[0]->foreignCurrencySymbol);
                                                                echo $currencySysmbol[1];
                                                                echo    '<span class="dueText"> '.number_format(($specificTr[6]), 2).'</span>';
                                                            } 
                                                        ?>
                                                    </td>
                                                </tr>
                                            ...
                                            <td class="text-right">
                                                <?php 
                                                    ...
                                                    if($purchaseInfo[0]->currencyType == 'local') {
                                                        ...
                                                        $currencySysmbol = explode("-", $basicSettings[0]->foreignCurrencySymbol);
                                                        echo $currencySysmbol[1];
                                                        echo    '<span class="dueText"> '.number_format(($subTotal), 2).'</span>';
                                                    }
                                                ?>
                                            </td>
                                        </tr>
                                                ...
                                                <?php 
                                                    if($purchaseInfo[0]->discountAmount != 0.00) { 
                                                        ...
                                                        if($purchaseInfo[0]->currencyType == 'local') {
                                                            ...
                                                            $currencySysmbol = explode("-", $basicSettings[0]->foreignCurrencySymbol);
                                                            echo $currencySysmbol[1];
                                                            echo    '<span class="dueText"> '.number_format(($discount), 2).'</span>';
                                                        }
                                                    } else { 
                                                        $currencySysmbol = explode("-", $basicSettings[0]->currencySymbol);
                                                        $localSymbol = $currencySysmbol[1];
                                                        if($purchaseInfo[0]->currencyType == 'local') {
                                                            ...
                                                            $currencySysmbol = explode("-", $basicSettings[0]->foreignCurrencySymbol);
                                                            echo $currencySysmbol[1];
                                                            echo    '<span class="dueText"> '.number_format((0.00), 2).'</span>';
                                                        }
                                                    }  ?>
                                                </td>
                                        </tr>
                                            ...
                                            <td class="text-right">
                                                <?php 
                                                    ...
                                                    if($purchaseInfo[0]->currencyType == 'local') {
                                                        ...
                                                        $currencySysmbol = explode("-", $basicSettings[0]->foreignCurrencySymbol);
                                                        echo $currencySysmbol[1];
                                                        echo    '<span class="dueText"> '.number_format(($purchaseInfo[0]->calculateTotal), 2).'</span>';
                                                    }
                                                ?>
                                            </td>
                                        </tr>
                                            ...
                                            <td id="paidText" class="text-right"> 
                                                <?php 
                                                    ...
                                                    if($purchaseInfo[0]->currencyType == 'local') {
                                                        ...
                                                        $currencySysmbol = explode("-", $basicSettings[0]->foreignCurrencySymbol);
                                                        echo $currencySysmbol[1];
                                                        echo    '<span class="dueText"> '.number_format(($purchaseInfo[0]->paidAmount), 2).'</span>';
                                                    }
                                                ?>
                                            </td>
                                        </tr>
        ...
        <script type="text/javascript">
            ...
            if(userId == '') {
                $.get(base_link+"estimate/statusCustomer/<?php echo $this->uri->segment(3); ?>/Estimate/PDF",{
                },
