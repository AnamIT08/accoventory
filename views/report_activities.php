										...
										<div id="portlet-body" class="portlet-body">
                                            ...
                                            <div class="table-scrollable">
                                                <table id="table-pagination" class="table table-striped table-hover green">
                                                    <thead>
                                                        <tr style="background-color: #E06666; color: #FFFFFF">
                                                            <th> # </th>
                                                            <th> Date & Time </th>
                                                            <th> Team Member </th>
                                                            <th> Activity </th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td> <?php echo $i++; ?> </td>
                                                            <td> <?php echo $detail->systemDateTime ?> </td>
                                                            <td>
                                                                <?php
                                                                    if($detail->userId == $this->session->userdata('id')) {
                                                                        echo "You ";
                                                                    } else {
                                                                        $vendor = $this->data_model->get_specific_column("name", array("id" => $detail->userId), "list_team"); echo $vendor[0]->name;
                                                                    }
                                                                ?>                                                                    
                                                            </td>
                                                            <td> 
                                                                <?php echo $detail->workType." ".$detail->docType; ?> 
                                                                <a class="linkGo" href="<?php echo base_url().$detail->fullLink ?>" target="_blank">
                                                                    <span class="label label-sm label-primary"> Go
