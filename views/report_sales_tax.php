										...
										<div id="portlet-body" class="portlet-body">
                                            ...
                                            <div class="table-scrollable">
                                                <table id="table-pagination" class="table table-striped table-hover green">
                                                    <thead>
                                                        <tr style="background-color: #CC4125; color: #FFFFFF">
                                                            <th> # </th>
                                                            <th> Tax Name </th>
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                            $sum = 0; $i = 1; foreach ($details as $detail) {
                                                            if($detail->taxId != 0) {
                                                        ?>
                                                        <tr>
                                                            <td> <?php echo $i++; ?> </td>
                                                            <td> <?php $tax = $this->data_model->get_specific_column("name", array("id" => $detail->taxId), "settings_tax"); echo $tax[0]->name; ?> </td>
                                                            <td style="text-align: right"> <?php $sum += number_format($detail->amount, 2); echo number_format($detail->amount, 2); ?> </td>
                                                        </tr>
                                                        <?php } } ?>
