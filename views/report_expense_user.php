										...
										<div id="portlet-body" class="portlet-body">
                                            ...
                                            <div class="table-scrollable">
                                                <table id="table-pagination" class="table table-striped table-hover green">
                                                    ...
                                                    <tbody>
                                                        <?php  $sum = 0; $due = 0; $i = 1; foreach ($detailsT as $detail) { ?>
                                                        <tr>
                                                            <td> <?php echo $i++; ?> </td>
                                                            <td> <?php echo $detail->createdDateTime ?> </td>
                                                            <td> <?php $team = $this->data_model->get_specific_column("name", array("id" => $detail->createdBy), "list_team"); echo $team[0]->name; ?> </td>
