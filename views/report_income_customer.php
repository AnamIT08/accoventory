										...
										<div id="portlet-body" class="portlet-body">
                                            ...
                                            <div class="table-scrollable">
                                                <table id="table-pagination" class="table table-striped table-hover green">
                                                    ...
                                                    <tbody>
                                                        <?php $sum = 0; $due = 0; $i = 1; foreach ($details as $detail) { ?>
                                                        <tr>
                                                            <td> <?php echo $i++; ?> </td>
                                                            <td> <?php echo $detail->createdDateTime ?> </td>
                                                            <td> 
                                                                <a href="<?php echo base_url();?>invoice/viewInvoice/<?php echo $detail->id; ?>" target="_blank">
                                                                    <?php 
                                                                        $customerId = $this->data_model->get_specific_column("customerId", array("systemId" => $detail->systemId), "list_document");
                                                                        $team = $this->data_model->get_specific_column("name", array("id" => $customerId[0]->customerId), "list_business_member"); echo $team[0]->name;
                                                                    ?>                                                                
                                                                </a>
                                                            </td>
                                                            <td> <a href="<?php echo base_url();?>invoice/viewInvoice/<?php echo $detail->id; ?>" target="_blank"><?php echo $detail->systemId ?></a> </td>
                                                            ...
                                                            <td style="text-align: right"> 
                                                                <?php
                                                                    ...
                                                                    echo number_format($detail->calculateTotalLocal-($resultIncome[0]->adjustAmount-$resultExpense[0]->adjustAmount), 2);
                                                                    $due += $detail->calculateTotalLocal-($resultIncome[0]->adjustAmount-$resultExpense[0]->adjustAmount);
                                                                ?>
                                                            </td>
                                                        </tr>
                                                        <?php } ?>
